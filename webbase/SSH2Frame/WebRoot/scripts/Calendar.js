...
document.writeln('<iframe id=wpCalendarLayer name=wpCalendarLayer frameborder=0 onmouseout="wpCalendar.correctPosition()" style="position: absolute; width: 153px; height: 208px; z-index: 9998; display: none"></iframe>');
...
function showCalendar() //主调函数
{
	...
	else dads.top  = ((ttyp=="image")? ttop+thei : ttop+thei+6)+"px";
