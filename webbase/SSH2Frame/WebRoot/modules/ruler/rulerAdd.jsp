...
<body>
	<div>
		<form action="RulerAction?method=add" id="opForm" name="opForm" method="post" >
				...
				<tr>
					<td>
						<table id="table-data-inner" cellspacing="0">
							<tr id="tr-menu-path" >
								<td  nowrap="nowrap">
								<fieldset id="f-menu-path">当前位置:&nbsp;菜单管理 &gt; 菜单添加</fieldset>
								</td>
							</tr>
				
							<tr>
								<td> 菜单名称：
									<input type="text" name="rulerInfo.rulerName" id="ruler_name"  style="color:#999999"  /> 		
								</td>
							</tr>
							<tr>
								<td> 上级菜单：
									<input type="text" name="rulerInfo.rulerManager" id="ruler_manager"  style="color:#999999" /> 		
								</td>
							</tr>
							<tr>
								<td> 菜单等级：
									<select name="rulerInfo.rulerLevel" id="ruler_manager" size="1">
