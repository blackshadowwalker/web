					...
					<td>
						<table id="table-data-inner" cellspacing="0">
							...
							<tr>
								<td>
								部门名称：
									<input type="text" name="dept.deptName" id="dept_name" value="部门名称" style="color:#999999" onblur="query0(this.id,this.value,'部门名称');" onfocus="query(this.id,this.value,'部门名称');"/> 
								上级部门:
