...
<body>
	 ...
	 <tr><td>
		<table id="table-data-inner" cellspacing="0">
			...
			<tr>
				<td>
				部门名称：
					<input type="text" name="dept.deptName" id="dept_name" value="${dept.deptName}" /> 
				上级部门:
					<input type="text" name="dept.deptManager" id="dept_manager" value="${dept.deptManager}" /> 
                         	 <!--                                                   
                                                                                 修改时间:
	...
	<div id="treegrid1" class="mini-treegrid" style="width:600px;height:280px;"     
	   url="<%=basePath %>/DeptAction?method=listTreeView&rulerId=${r_id}" ondrawcell="onDrawCell" showTreeIcon="true"  
	...
	>
	    <div property="columns">
	        ...
	        <div name="deptName" field="deptName" width="180">部门名称
	        <input property="editor" class="mini-textbox" style="width:100%;"  /> 
	        </div> 
	        <div name="deptManager" field="deptManager" width="150">上级部门
	        <input property="editor" class="mini-textbox" style="width:100%;"  /> 
	        </div> 
	        <div field="lastUpdate" width="110" dateFormat="yyyy-MM-dd">最后修改日期
	        <input property="editor" class="mini-datepicker" style="width:100%;" />
	        </div>
	         <div field="operator" width="110" >操作
	         </div>        
	    </div>
	</div>
	<script type="text/javascript">
		...
		//alert("可以调用到该方法");
		//alert(name);
		location.href="<%= basePath%>/modules/dept/deptAdd.jsp?mname="+name;
	}
