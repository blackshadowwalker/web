				...
				<tr>
					<td>
						<table id="table-data-inner" cellspacing="1">
							...
							<tr id="tr-title"><td colspan="2">添加用户</td></tr>
							<tr>
							...
							<tr>
								...
								<td width="30%" class="field-content"><s:textfield id="rname" name="userInfo.userBirth" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="true" cssClass="Wdate"></s:textfield></td>
							</tr>
							<tr>
