...
CREATE TABLE `kk_20130508_165150` (
  ...
  `CLSSID` int(11) DEFAULT NULL COMMENT '摄像头CLSSID',
  `LPNumber` varchar(15) DEFAULT NULL COMMENT '车牌',
  `speed` int(3) DEFAULT NULL COMMENT '速度',
...
) ENGINE=InnoDB DEFAULT CHARSET=gbk COMMENT='事件表  KK';
...
INSERT INTO t_s_baseinfo VALUES ('34', '1379298205889', '智能交通卡口系统', '建议使用IE浏览器，分辨率在1024*768以上', '1', '1', '2013-09-16 10:23:26', '0.1');
...
INSERT INTO t_s_blacklist VALUES ('4', 'TEST', '冀BM1762', '2', '', '4', '', '2013-09-16 11:19:05', '1');
...
INSERT INTO t_s_cameratable VALUES ('9', null, 'DH', 'DH113', 'camera9', 'dl', 'server5', 'nvr1', '10.168.1.113', '255.255.255.0', '10.168.1.1', '37777', 'admin', 'admin', '116.310648', '40.022995', '15', null, '1', '2013-09-03 16:32:19');
INSERT INTO t_s_cameratable VALUES ('10', null, 'DH', 'DH115', 'camera10', 'dl010101', 'server5', 'nvr1', '10.168.1.115', '255.255.255.0', '10.168.1.1', '37777', 'admin', 'admin', '116.321553', '40.024956', '17', null, '1', '2013-09-03 16:32:19');
...
INSERT INTO t_s_databack VALUES ('298', 'system', '20130807000719.sql', '20130807000719.sql', 'd:/webapps/its/WEB-INF/DBBackUp/20130807000719.sql', '5236', '2013-08-07 00:07:20', '', '', '0', '1');
...
-- ----------------------------
INSERT INTO t_s_eventtablemanager VALUES ('1', 'KK', 'kk_20130508_165150', 'System', null, '1', '2013-09-16 11:31:20', '2013-09-16 11:25:23', '', '1', null, '保留');
...
CREATE TABLE `t_s_illegalevent` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `CLSSID` varchar(10) DEFAULT NULL COMMENT '摄像头CLSSID',
  `LPNumber` varchar(15) DEFAULT NULL COMMENT '车牌',
  `lane` varchar(15) DEFAULT NULL COMMENT '车道',
  `violations` varchar(15) DEFAULT NULL COMMENT '交通违规类型:闯红灯/逆行/压线/变道',
  `speed` int(3) DEFAULT NULL COMMENT '速度',
  `modelCode` varchar(15) DEFAULT NULL COMMENT '车型代码',
  `logoCode` varchar(15) DEFAULT NULL COMMENT '车标代码',
  `carColor` varchar(15) DEFAULT NULL COMMENT '车颜色',
  `LPNColor` varchar(15) DEFAULT NULL COMMENT '车牌颜色',
  ...
  `ctTime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '检测时间',
  `absTime` timestamp NULL DEFAULT NULL,
  `audit` varchar(63) DEFAULT NULL COMMENT '审核状态',
  `auditer` varchar(255) DEFAULT NULL COMMENT '审核人',
  `audittime` varchar(15) DEFAULT NULL COMMENT '审核时间',
  `reviewer` varchar(255) DEFAULT NULL COMMENT '复审人',
  `reviewtime` varchar(15) DEFAULT NULL COMMENT '复审时间',
  `finaler` varchar(255) DEFAULT NULL COMMENT '终审人',
  `finaltime` varchar(15) DEFAULT NULL COMMENT '终审时间',
  `shortImageCom` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=gbk COMMENT='交通违法事件';
...
CREATE TABLE `t_s_offline_event` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18022 DEFAULT CHARSET=gbk;

-- ----------------------------
-- Records of t_s_offline_event
-- ----------------------------
INSERT INTO t_s_offline_event VALUES ('9732', 'C:UsersceshijiDesktop20130613_160122 - 副本.avi', '333', '2013-06-27 11:36:23', '3', 'kk', '01', '京NT1390', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel1/2013_06_27_11_36_23_959_5.jpg', '/pic/channel1/2013_06_27_11_36_23_959_5a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9733', 'C:UsersceshijiDesktop20130613_160122.avi', '333', '2013-06-27 11:36:25', '3', 'kk', '01', '京NT1390', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel2/2013_06_27_11_36_25_106_5.jpg', '/pic/channel2/2013_06_27_11_36_25_106_5a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9734', 'C:UsersceshijiDesktop20130613_160122 - 副本.avi', '1066', '2013-06-27 11:36:25', '2', 'kk', '01', '京NZ0U68', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel1/2013_06_27_11_36_25_331_16.jpg', '/pic/channel1/2013_06_27_11_36_25_331_16a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9735', 'C:UsersceshijiDesktop20130613_160122.avi', '1066', '2013-06-27 11:36:26', '2', 'kk', '01', '京NZ0U68', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel2/2013_06_27_11_36_26_533_16.jpg', '/pic/channel2/2013_06_27_11_36_26_533_16a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9736', 'C:UsersceshijiDesktop20130613_160122 - 副本.avi', '333', '2013-06-27 11:36:28', '3', 'kk', '01', '京NT1390', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel1/2013_06_27_11_36_28_845_5.jpg', '/pic/channel1/2013_06_27_11_36_28_845_5a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9737', 'C:UsersceshijiDesktop20130613_160122 - 副本.avi', '1066', '2013-06-27 11:36:30', '2', 'kk', '01', '京NZ0U68', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel1/2013_06_27_11_36_30_273_16.jpg', '/pic/channel1/2013_06_27_11_36_30_273_16a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9738', 'C:UsersceshijiDesktop20130613_160122.avi', '333', '2013-06-27 11:36:32', '3', 'kk', '01', '京NT1390', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel2/2013_06_27_11_36_32_353_5.jpg', '/pic/channel2/2013_06_27_11_36_32_353_5a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9739', 'C:UsersceshijiDesktop20130613_160122.avi', '333', '2013-06-27 11:36:35', '3', 'kk', '01', '京NT1390', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel2/2013_06_27_11_36_35_618_5.jpg', '/pic/channel2/2013_06_27_11_36_35_618_5a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9740', 'C:UsersceshijiDesktop20130613_160122 - 副本.avi', '4133', '2013-06-27 11:36:35', '1', 'kk', '01', '京H68646', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel1/2013_06_27_11_36_35_827_62.jpg', '/pic/channel1/2013_06_27_11_36_35_827_62a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9741', 'C:UsersceshijiDesktop20130613_160122.avi', '1066', '2013-06-27 11:36:36', '2', 'kk', '01', '京NZ0U68', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel2/2013_06_27_11_36_36_969_16.jpg', '/pic/channel2/2013_06_27_11_36_36_969_16a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9742', 'C:UsersceshijiDesktop20130613_160122 - 副本.avi', '333', '2013-06-27 11:36:23', '3', 'kk', '01', '京NT1390', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel1/2013_06_27_11_36_23_959_5.jpg', '/pic/channel1/2013_06_27_11_36_23_959_5a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9743', 'C:UsersceshijiDesktop20130613_160122.avi', '333', '2013-06-27 11:36:25', '3', 'kk', '01', '京NT1390', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel2/2013_06_27_11_36_25_106_5.jpg', '/pic/channel2/2013_06_27_11_36_25_106_5a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9744', 'C:UsersceshijiDesktop20130613_160122 - 副本.avi', '1066', '2013-06-27 11:36:25', '2', 'kk', '01', '京NZ0U68', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel1/2013_06_27_11_36_25_331_16.jpg', '/pic/channel1/2013_06_27_11_36_25_331_16a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9745', 'C:UsersceshijiDesktop20130613_160122.avi', '1066', '2013-06-27 11:36:26', '2', 'kk', '01', '京NZ0U68', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel2/2013_06_27_11_36_26_533_16.jpg', '/pic/channel2/2013_06_27_11_36_26_533_16a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9746', 'C:UsersceshijiDesktop20130613_160122 - 副本.avi', '333', '2013-06-27 11:36:28', '3', 'kk', '01', '京NT1390', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel1/2013_06_27_11_36_28_845_5.jpg', '/pic/channel1/2013_06_27_11_36_28_845_5a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9747', 'C:UsersceshijiDesktop20130613_160122 - 副本.avi', '1066', '2013-06-27 11:36:30', '2', 'kk', '01', '京NZ0U68', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel1/2013_06_27_11_36_30_273_16.jpg', '/pic/channel1/2013_06_27_11_36_30_273_16a.jpg', '', '', '');
INSERT INTO t_s_offline_event VALUES ('9748', 'C:UsersceshijiDesktop20130613_160122.avi', '333', '2013-06-27 11:36:32', '3', 'kk', '01', '京NT1390', '0', '', 'blue_white', '', 'normal_blue', 'small', '/pic/channel2/2013_06_27_11_36_32_353_5.jpg', '/pic/channel2/2013_06_27_11_36_32_353_5a.jpg', '', '', '');
...
CREATE TABLE `t_s_rolevalue` (
  ...
  `status` int(11) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3254 DEFAULT CHARSET=gbk COLLATE=gbk_bin;
...
CREATE TABLE `t_s_ruler` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1550 DEFAULT CHARSET=gbk COLLATE=gbk_bin;
...
INSERT INTO t_s_ruler VALUES ('1353', 'nksbfb', '鸟瞰设备分布', '', '', '1', '1', 'sbxxgl', null, '1', '2013-03-29 13:57:52', '0', null);
...
CREATE TABLE `t_s_uploadfiles` (
  ...
  `status` int(2) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=gbk COMMENT='记录上传文件';
...
INSERT INTO t_s_uploadfiles VALUES ('62', '1379298205889', 'logo', 'logo', '/upload/logo/logo_201309161023240.png', '2013-09-16 10:23:00', null, '1');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `t_s_trafficviol` AS select `kk`.`dzjc_20130426_183246`.`violations` AS `violations`,substr(`kk`.`dzjc_20130426_183246`.`absTime`,1,7) AS `substr(absTime,1,7)`,count(1) AS `count(1)`,avg(`kk`.`dzjc_20130426_183246`.`speed`) AS `avg(speed)`,`kk`.`dzjc_20130426_183246`.`CLSSID` AS `CLSSID` from `dzjc_20130426_183246` where (substr(`kk`.`dzjc_20130426_183246`.`absTime`,1,4) = '2013') group by substr(`kk`.`dzjc_20130426_183246`.`absTime`,1,7),`kk`.`dzjc_20130426_183246`.`violations`,`kk`.`dzjc_20130426_183246`.`CLSSID`;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`%` SQL SECURITY DEFINER VIEW `view_tjfx` AS select substr(`kk`.`dzjc_20130426_183246`.`ctTime`,1,7) AS `substr(ctTime,1,7)`,count(0) AS `count(*)` from `dzjc_20130426_183246` group by substr(`kk`.`dzjc_20130426_183246`.`ctTime`,1,7);
