...
<script>
    ...
    watchedFolderBean.watchedFolderDetail(rowID,
    {
        callback:function(data)
        {
            ...
            document.write("<tr><td class=tablebodyhead width=150px><bean:message key="watchedfolder.label.id" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[0]+"</td></tr>");
            document.write("<tr><td class=tablebodyhead width=150px><bean:message key="watchedfolder.label.plnumber" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[1]+"</td></tr>");
            document.write("<tr><td class=tablebodyhead width=150px><bean:message key="watchedfolder.label.framects" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[2]+"</td></tr>");

            document.write("<tr><td class=tablebodyhead width=150px><bean:message key="watchedfolder.label.abstime" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[3]+"</td></tr>");
            document.write("<tr><td class=tablebodyhead width=150px><bean:message key="watchedfolder.label.location" bundle="${language}"/></td>");
