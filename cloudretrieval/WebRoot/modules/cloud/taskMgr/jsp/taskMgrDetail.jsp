...
<script>
    ...
    taskMgrBean.detailTask(rowID,
    {
        callback:function(data)
        {
            ...
            document.write("<tr><td class=tablebodyhead width=70px><bean:message key="task.columns.taskNumbe" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[0]+"</td></tr>");
            document.write("<tr><td class=tablebodyhead width=70px><bean:message key="task.columns.taskName" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[1]+"</td></tr>");
            document.write("<tr><td class=tablebodyhead width=70px><bean:message key="task.columns.taskStatus" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[2]+"</td></tr>");
           	document.write("<tr><td class=tablebodyhead width=70px><bean:message key="task.columns.locationName" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[3]+"</td></tr>");
            document.write("<tr><td class=tablebodyhead width=150px><bean:message key="task.columns.input" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[4]+"</td></tr>");
            document.write("<tr><td class=tablebodyhead width=70px><bean:message key="task.columns.founder" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[5]+"</td></tr>");
            document.write("<tr><td class=tablebodyhead width=150px><bean:message key="task.columns.creationTime" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[6]+"</td></tr>");
            document.write("<tr><td class=tablebodyhead width=150px><bean:message key="task.columns.lastUpdateTime" bundle="${language}"/></td>");
