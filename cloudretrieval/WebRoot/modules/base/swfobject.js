...
deconcept.SWFObject = function(swf, id, w, h, ver, c, quality, xiRedirectUrl,
	...
	if (ver) {
		this.setAttribute('version', new deconcept.PlayerVersion(ver.toString()
						.split(".")));
	}
...
deconcept.SWFObject.prototype = {
	...
	getSWFHTML : function() {
		...
		if (navigator.plugins && navigator.mimeTypes
				&& navigator.mimeTypes.length) { // netscape plugin
													// architecture
...
deconcept.SWFObjectUtil.getPlayerVersion = function() {
	...
	if (navigator.plugins && navigator.mimeTypes.length) {
		...
		if (x && x.description) {
			...
			&& navigator.userAgent.indexOf("Windows CE") >= 0) { // if
																	// Windows
																	// CE
		var axo = 1;
		var counter = 3;
		...
		if (axo != null) {
			PlayerVersion = new deconcept.PlayerVersion(axo
