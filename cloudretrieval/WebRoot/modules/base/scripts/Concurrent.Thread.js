(function() {
	if (!this.Data
			|| (typeof this.Data != 'object' && typeof this.Data != 'function'))
	...
	with (function() {
		with (Data) {
			...
			return function() {
				 ...
				 * 
				 * The Initial Developer of the Original Code is Daisuke Maki.
				 * Portions created by the Initial Developer are Copyright (C)
				 * 2006 the Initial Developer. All Rights Reserved.
				 * 
				 * Contributor(s):
				 * 
				 * Alternatively, the contents of this file may be used under
				 * the terms of either the GNU General Public License Version 2
				 * or later (the "GPL"), or the GNU Lesser General Public
				 * License Version 2.1 or later (the "LGPL"), in which case the
				 ...
				 * of this file under the terms of any one of the MPL, the GPL
				 * or the LGPL.
				 * 
				 * ***** END LICENSE BLOCK *****
				 */
...
(function() {
	if (!this.WebBrowser
			|| (typeof this.WebBrowser != 'object' && typeof this.WebBrowser != 'function'))
		this.WebBrowser = new Object();
	if (!this.WebBrowser.GUI
			|| (typeof this.WebBrowser.GUI != 'object' && typeof this.WebBrowser.GUI != 'function'))
			...
			return function() {
				...
				function attach(element, type, listener, useCapture) {
					if (!element || typeof element !== "object") {
						throw new TypeError("argument not a element: "
								+ element);
					}
					type = String(type);
					if (typeof listener !== "function") {
						throw new TypeError("argument not a function: "
								+ listener);
					}
					...
					function handler(e) {
						e = e || window.event;
						if (!e.stopPropagation) { // Sets standard properties
													// for IE
				...
				function detach(element, type, listener, useCapture) {
					if (arguments.length === 1 && typeof element === "number") {
						...
						return detach_aux(reg.element, reg.type, reg.handler,
								reg.useCapture);
					} else {
						if (!element || typeof element !== "object") {
						...
						type = String(type);
						if (typeof listener !== "function") {
							throw new TypeError("argument is not s function: "
									+ listener);
						}
						useCapture = Boolean(useCapture);
						var ret_val = false;
						for (var i in registry) {
							var reg = registry[i];
							if (reg.element === element && reg.type === type
									&& reg.listener === listener
									&& reg.useCapture === useCapture) {
								delete registry[i];
								ret_val = detach_aux(reg.element, reg.type,
										reg.handler, reg.useCapture)
										|| ret_val;
							}
						}
						return ret_val;
...
(function() {
	if (!this.Math
			|| (typeof this.Math != 'object' && typeof this.Math != 'function'))
			...
			return function() {
				...
				function register(type, exec) {
					if (typeof exec != "function")
						throw new TypeError("function required, but got: "
								+ exec);
				...
				function exec() {
					...
					for (var i = 0; i < metas.length; i++) {
						if (String(metas[i].httpEquiv)
								.match(/^Content-Script-Type$/i)) {
...
(function() {
	if (!this.JSON
			|| (typeof this.JSON != 'object' && typeof this.JSON != 'function'))
		...
		with (JSON) {
			...
			return function() {
							...
							if (data === null) {
								...
								for (var i in data) {
									if (data.hasOwnProperty(i)) {
										arr.push(dump_string(i) + ":"
												+ dump_main(data[i], opts));
									}
								}
								if (opts.pretty) {
									return "{\n"
				...
				String.prototype[DUMPER] = function(opts) {
					return opts.deflate
							? "new String(" + dump_string(this.toString())
									+ ")"
				...
				RegExp.prototype[DUMPER] = function(opts) {
					return opts.deflate ? this.toString() : dump_string(this
							.toString());
				};
...
(function() {
	if (!this.Data
		...
		this.Data = new Object();
	if (!this.Data.Cons
			|| (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
			...
			return function() {
				...
				proto.toLocaleString = function() {
					return "("
							+ (this.car == null
									? String(this.car)
									: this.car.toLocaleString)
							+ " . "
							+ (this.cdr == null
									? String(this.cdr)
									: this.cdr.toLocaleString) + ")";
				};
...
(function() {
	if (!this.Util
			|| (typeof this.Util != 'object' && typeof this.Util != 'function'))
		this.Util = new Object();
	if (!this.Util.Arrayize
			|| (typeof this.Util.Arrayize != 'object' && typeof this.Util.Arrayize != 'function'))
...
(function() {
	if (!this.Data
			|| (typeof this.Data != 'object' && typeof this.Data != 'function'))
		this.Data = new Object();
	if (!this.Data.Functional
			|| (typeof this.Data.Functional != 'object' && typeof this.Data.Functional != 'function'))
		...
		with (Data.Functional.Loop) {
			with (Data.Functional) {
				...
				return function() {
					...
					/***********************************************************
					 * ***** BEGIN LICENSE BLOCK Version: MPL 1.1/GPL 2.0/LGPL
					 * 2.1
					 * 
					 ...
					 * 
					 * The Initial Developer of the Original Code is Daisuke
					 * Maki. Portions created by the Initial Developer are
					 * Copyright (C) 2005-2007 the Initial Developer. All Rights
					 * Reserved.
					 * 
					 * Contributor(s):
					 * 
					 ...
					 * Version 2 or later (the "GPL"), or the GNU Lesser General
					 * Public License Version 2.1 or later (the "LGPL"), in
					 * which case the provisions of the GPL or the LGPL are
					 * applicable instead of those above. If you wish to allow
					 ...
					 * this file under the terms of any one of the MPL, the GPL
					 * or the LGPL.
					 * 
					 * ***** END LICENSE BLOCK *****
					 */
					...
					function wrap_for_fold(t, f, s) {
						...
						return function(v) {
							try {
								...
								if (e instanceof DiscontinueException) {
									throw new EndOfLoopException(e.args[e.args.length
											- 1]);
								} else if (e instanceof IgnoreException) {
									return s;
								} else if (e instanceof ReturnListException) {
...
(function() {
	if (!this.Data
		...
		this.Data = new Object();
	if (!this.Data.Error
			|| (typeof this.Data.Error != 'object' && typeof this.Data.Error != 'function'))
	...
	with (function() {
		with (Data.Error) {
			...
			return function() {
				 ...
				 * The Initial Developer of the Original Code is Daisuke Maki.
				 * Portions created by the Initial Developer are Copyright (C)
				 * 2005-2006 the Initial Developer. All Rights Reserved.
				 * 
				 * Contributor(s):
				 * 
				 * Alternatively, the contents of this file may be used under
	...
	with (function() {
		with (Data.Error) {
			...
			return function() {
				...
				var UnimplementedMethodError = Error.extend(function($super,
								method, invocant, message) {
							if (message !== undefined) {
								$super(message);
							} else {
								$super("an required method `" + method
...
(function() {
	...
	if (!this.Data.Iterator
			|| (typeof this.Data.Iterator != 'object' && typeof this.Data.Iterator != 'function'))
		...
		with (Data.Error) {
			with (Data.Iterator) {
				...
				return function() {
					 ...
					 * The Initial Developer of the Original Code is Daisuke
					 * Maki. Portions created by the Initial Developer are
					 * Copyright (C) 2006 the Initial Developer. All Rights
					 * Reserved.
					 * 
					 * Contributor(s):
					 * 
					...
					var NoSuchElementError = Error.extend(function($super,
									message) {
								$super(message);
							}, {
			...
			with (Data.Functional.Loop) {
				with (Data.Functional) {
					...
					return function() {
						...
						/*******************************************************
						 * ***** BEGIN LICENSE BLOCK Version: MPL 1.1/GPL
						 * 2.0/LGPL 2.1
						 * 
						 * The contents of this file are subject to the Mozilla
						 ...
						 * The Initial Developer of the Original Code is Daisuke
						 * Maki. Portions created by the Initial Developer are
						 * Copyright (C) 2005-2007 the Initial Developer. All
						 * Rights Reserved.
						 * 
						 * Contributor(s):
						 * 
						 ...
						 * License Version 2 or later (the "GPL"), or the GNU
						 * Lesser General Public License Version 2.1 or later
						 * (the "LGPL"), in which case the provisions of the GPL
						 * or the LGPL are applicable instead of those above. If
						 * you wish to allow use of your version of this file
						 * only under the terms of either the GPL or the LGPL,
						 * and not to allow others to use your version of this
						 * file under the terms of the MPL, indicate your
						 * decision by deleting the provisions above and replace
						 * them with the notice and other provisions required by
						 * the GPL or the LGPL. If you do not delete the
						 * provisions above, a recipient may use your version of
						...
						proto.forEach = function(f) {
							...
							for (var it = this.iterator(); !it.isTail(); it = it
									.next()) {
								try {
									f(it.value());
								} catch (e) {
						...
						var EmptyEnumerationError = Error.extend(function(
										$super, message) {
									$super(message);
								}, {
		...
		with (Data.Error) {
			with (Data.Iterator) {
				...
				return function() {
					...
					// Returns true if this iterator points to the tail of a
					// list,
					// false othersise.
					// The default implementation merely throws
					// UnimplementedMethodError.
					// Sub-classes must implement their own version of this
					// method.
					proto.isTail = function() {
						throw new UnimplementedMethodError("isTail", this);
					};

					// Returns value of the element which is just after the
					// position
					...
					// Returns a new iterator that points to the next position
					// to the
					...
					// Returns true if and only if this iterator is associated
					// with the
		...
		with (Data.Error) {
			with (Data.Iterator) {
				...
				return function() {
					...
					// Returns true if this iterator points to the head of a
					// list,
					// false othersise.
					// The default implementation merely throws
					// UnimplementedMethodError.
					...
					// Returns a new iterator that points to the previous
					// position to
					...
					return function() {
						...
						proto.removeAll = function( /* variable args */) {
							...
							for (var i = 0; i < arguments.length; i++) {
								var e = arguments[i];
								if (e instanceof Array) {
									changed = this.remove.apply(this, e)
											|| changed;
								} else if (e instanceof Collection) {
									var self = this;
									e.forEach(function(it) {
												changed = self.remove(it)
														|| changed;
											});
								} else {
			...
			with (Data.Functional.Loop) {
				with (Data.Functional) {
					...
					return function() {
						...
						// Iterator methods.
						// Return an iterator pointing to just before the n'th
						// element
						// (the first element is the 0th one). If there are only
						// n elements
						// in this list, return an iterator pointing to the
						// tail.
						// If n is negative, it is treated as size+n, where size
						// is the length
						// of this list. Thus, if n is negative, the result of
						// head(n) and
						...
						// If there is no corresponding value in this list,
						// returns undefined.
						// The argument can be either number or iterator.
						proto.get = function(it) {
							if (!(it instanceof List.Iterator && it
									.isBoundTo(this))) {
								try {
									it = this.head(it);
								} catch (e) {
						...
						// Assigns the second argument to the container indexed
						// by the first
						// argument.
						// The argument can be either number or iterator.
						...
						// Inserts a new container at the position indexed by
						// the first
						// argument, and sets the second argument to the
						// container, then,
						// returns the value of the container.
						// The argument can be either number or iterator.
						// The position which this iterator points to after
						// insertion is
						...
						// Removes the container indexed by the argument, then,
						// returns the
						...
						proto.reverse = function() {
							...
							for (var it = this.reverseHead(); !it.isTail(); it = it
									.next()) {
								r.add(it.value());
							}
							return r;
						...
						proto.slice = function(start, end) {
							if (!(start instanceof List.Iterator
									...
									&& start.isBoundTo(this)
									&& end.isBoundTo(this) && start.constructor === end.constructor)) // one
																										// might
																										// be
																										// reverse-iterator
																										// even
			...
			with (Data.Iterator) {
				with (Data.Functional.List) {
					...
					return function() {
						...
						// Assign the argument to the element which is just
						// after the position
						// this iterator points to, then returns the new value
						// of the element,
						// which can be defferent from the argument.
						// The effect of assignment at the tail of a list should
						// be identical
						...
						// Inserts a new container at the position which this
						// iterator points
						// to and sets the argument to the container, then,
						// returns the value
						// of the container, which can be defferent from the
						// argument.
						// The position which the iterator points to after
						// insertion is
						// implementation-dependent.
						// The default implementation merely throws
						// UnimplementedMethodError.
						...
						// Removes the container just after the position which
						// this iterator
						...
						// Returns true if both this iterator and the argument
						// points to the same position,
						// false otherwise.
						// The default implementation is based on `compareTo'
						// method.
						proto.equals = function(that) {
							return this.compareTo(that) === 0;
						};

						// Returns the distance of this iterator and the
						// argument,
						// or undefined if the iterators seem to point to
						// defferent list.
						// A negative return value means the arguments succeeds
						// this iterator
						// and its magnitude represents the distance of them.
						// Thus, this can be
						// used as comparison-function.
						// The default implementation is based on `next',
						// `equals' and `isTail' method.
						proto.distance = proto.compareTo = function(that) {
							if (!(that instanceof Iterator))
								return undefined;
							for (var i = 0, l = this, r = that;; i--, l = l
									.next()) {
								if (l.equals(r))
									return i;
								if (l.isTail())
							...
							for (var i = 1, l = that.next(), r = this;; i++, l = l
									.next()) {
								if (l.equals(r))
									return i;
								if (l.isTail())
...
(function() {
	with (function() {
		...
		return function() {
			 ...
			 * your version of this file under the terms of any one of the MPL,
			 * the GPL or the LGPL.
			 * 
			 * ***** END LICENSE BLOCK *****
			 */
			...
			// See "Data.Functional.List.list" for the entity of
			// "Data.Functional.List".
						...
						with (Data.Functional) {
							with (Data.Cons) {
								...
								return function() {
									...
									/*******************************************
									 * ***** BEGIN LICENSE BLOCK Version: MPL
									 ...
									 * Code is Daisuke Maki. Portions created by
									 * the Initial Developer are Copyright (C)
									 * 2007 the Initial Developer. All Rights
									 * Reserved.
									 * 
									 * Contributor(s):
									 * 
									 * Alternatively, the contents of this file
									 * may be used under the terms of either the
									 * GNU General Public License Version 2 or
									 * later (the "GPL"), or the GNU Lesser
									 * General Public License Version 2.1 or
									 * later (the "LGPL"), in which case the
									 * provisions of the GPL or the LGPL are
									 * applicable instead of those above. If you
									 * wish to allow use of your version of this
									 * file only under the terms of either the
									 * GPL or the LGPL, and not to allow others
									 * to use your version of this file under
									 * the terms of the MPL, indicate your
									 * decision by deleting the provisions above
									 * and replace them with the notice and
									 * other provisions required by the GPL or
									 * the LGPL. If you do not delete the
									 * provisions above, a recipient may use
									 * your version of this file under the terms
									 * of any one of the MPL, the GPL or the
									 * LGPL.
									 * 
									 * ***** END LICENSE BLOCK *****
									 */
									...
									function list( /* variable args */) {
										...
										for (var i = 0; i < arguments.length; i++) {
											cell = cell.cdr = new Cell(
													arguments[i], cell.cdr);
										}
										return head.cdr;
									}
									...
									proto.tail = function(n) {
										...
										if (n < 0)
											return this.head(-n);
										for (var it = new Iterator(this, this,
												null); !it.isTail(); it = it
												.next());
										try {
									...
									proto.copy = function() {
										if (this.isNil())
											return new Nil();
										var head, cell;
										head = cell = new Cell(this.car,
												new Nil());
										for (var c = this.cdr; !c.isNil(); c = c.cdr) {
											cell = cell.cdr = new Cell(c.car,
													cell.cdr);
										}
										return head;
									};
									...
									proto.slice = function(start, end) {
										if (!((start instanceof Iterator
												&& end instanceof Iterator || start instanceof ReverseIterator
												&& end instanceof ReverseIterator)
												&& start.isBoundTo(this) && end
												.isBoundTo(this))) {
											try {
												start = this.head(start);
											} catch (e) {
									...
									proto.insert = function(v) {
										if (this.isHead())
											throw new InsertAtHeadError();
										this._cell = this._prev._cell.cdr = new Cell(
												v, this._cell.cdr);
										return v;
									};
									...
									proto.compareTo = proto.distance = function(
											that) {
										if (!(that instanceof Iterator && that
												.isBoundTo(this._head)))
											return undefined;
										for (var i = 0, l = this._cell, r = that._cell; !l
												.isNil(); i++, l = l.cdr) {
											if (l === r)
												return -i;
										}
										for (var i = 1, l = that._cell.cdr, r = this._cell; !l
												.isNil(); i++, l = l.cdr) {
											if (l === r)
												return i;
										}
									...
									function ReverseIterator() {
										return List.ReverseIterator.apply(this,
												arguments);
									}
				...
				with (Data.Functional.Loop) {
					with (Data.Functional) {
						...
						return function() {
							 ...
							 * Mozilla Public License Version 1.1 (the
							 ...
							 * Daisuke Maki. Portions created by the Initial
							 * Developer are Copyright (C) 2005-2007 the Initial
							 * Developer. All Rights Reserved.
							 * 
							 * Contributor(s):
							 * 
							 * Alternatively, the contents of this file may be
							 * used under the terms of either the GNU General
							 * Public License Version 2 or later (the "GPL"), or
							 * the GNU Lesser General Public License Version 2.1
							 * or later (the "LGPL"), in which case the
							 * provisions of the GPL or the LGPL are applicable
							 * instead of those above. If you wish to allow use
							 * of your version of this file only under the terms
							 * of either the GPL or the LGPL, and not to allow
							 * others to use your version of this file under the
							 * terms of the MPL, indicate your decision by
							 * deleting the provisions above and replace them
							 * with the notice and other provisions required by
							 * the GPL or the LGPL. If you do not delete the
							 * provisions above, a recipient may use your
							 * version of this file under the terms of any one
							...
							proto.reverseTail = function(n) {
								...
								if (n > this.length)
									throw new RangeError();
								return new ReverseIterator(this, this.length
												- n);
							};
							...
							proto.next = function() {
								...
								if (this.isHead())
									...
									return new this.constructor(this._arr,
											this._pos + 1);
							};
							...
							proto.insert = function(v) {
								...
								if (i <= 0)
									...
									i = min(i, this._arr.length);
								return this._arr.insertAt(this._arr.length - i,
										v);
							};
							...
							proto.remove = function() {
								if (this.isTail())
									throw new IllegalStateError("can't remove at the tail of list");
								if (this.isHead())
									return this._arr.splice(this._arr.length
													- 1, 1)[0];
								else
									return this._arr.splice(this._arr.length
													- 1 - ToInteger(this._pos),
											1)[0];
							};
						...
						with (Data.Functional) {
							with (Data) {
								...
								return function() {
									 ...
									 * under the License.
									 * 
									 * The Original Code is Data.LinkedList
									 * module.
									 * 
									 * The Initial Developer of the Original
									 * Code is Daisuke Maki. Portions created by
									 * the Initial Developer are Copyright (C)
									 * 2005-2007 the Initial Developer. All
									 * Rights Reserved.
									 * 
									 * Contributor(s):
									 * 
									...
									LinkedList.fromCollection = function( /*
																			 * variable
																			 * args
																			 */) {
									...
									proto.head = function(n) {
										if (n < 0)
											return this.tail(-n);
										return new Iterator(this, nForward(
														this, this._next,
														ToInteger(n)));
									};
									...
									proto.tail = function(n) {
										if (n < 0)
											return this.head(-n);
										return new Iterator(this, nBackward(
														this, this,
														ToInteger(n)));
									};
									...
									proto.pop = function() {
										return (new Iterator(this, this._prev))
												.remove();
									};

									proto.shift = function() {
										return (new Iterator(this, this._next))
												.remove();
									};
									...
									proto.foldr = function(f, s) {
										var g = wrap_for_fold(this, function(x,
														y) {
													return f.call(this, y, x);
												}, s);
									...
									function Iterator(l, c) {
										this._top = l; // LinkedList object
														// which this iterator
														// belongs to.
										this._pos = c; // Current position;
														// abstractly iterator
									...
									proto.compareTo = function(that) {
										...
										validate(this);
										validate(that);
										return comp(this._top, this._pos,
												that._pos);
									};
									...
									proto.distance = function(that) {
										...
										validate(this);
										validate(that);
										return dist(this._top, this._pos,
												that._pos);
									};
									...
									proto.distance = function(that) {
										...
										rvalidate(this);
										rvalidate(that);
										var d = dist(this._top, this._pos,
												that._pos);
										return isNaN(d) ? d : -d;
									};
									...
									proto.next = function() {
										if (this.isTail())
											throw new NoSuchElementError("no next element");
										return new ReverseIterator(this._top,
												this._pos._prev);
									};
...
(function() {
	...
	if (!this.Data.Error
		...
		this.Data.Error = new Object();
	if (!this.Concurrent
			|| (typeof this.Concurrent != 'object' && typeof this.Concurrent != 'function'))
		...
		with (Data.Error) {
			with (Concurrent) {
				...
				return function() {
					 ...
					 * The Initial Developer of the Original Code is Daisuke
					 * Maki. Portions created by the Initial Developer are
					 * Copyright (C) 2006-2007 the Initial Developer. All Rights
					 * Reserved.
					 * 
					 * Contributor(s):
					 * 
					...
					// Cyclic reference ensures that at least one exceptinal
					// continuation always exists.
					...
					function standBy(t) {
						...
						this._timerID = setTimeout(function() {
									doNext.call(self);
								}, Number(t) || 2 // some version of IE
													// occationally fails to
					...
					function unjoin() {
						if (this._join_thread) {
							var self = this;
							var it = this._join_thread._joined_list.head()
									.find(function(it) {
												return it === self;
											});
							it.remove();
					...
					function doNext() {
						...
						try {
							...
							do {
								try {
									triplet = triplet.continuation.procedure
											.call(
							...
							} while (triplet.timeout === undefined
					...
					proto.kill = function(s) {
						return this.notify(arguments.length
								? new KillException(s)
								: new KillException());
					};
					...
					proto.join.$Concurrent_Thread_compiled = function(this_val,
							args, cont) {
						// !TODO: check cyclic-join
						if (this_val._is_ended > 0) { // this thread has
														// already ended
														// normally
							return {
								continuation : cont,
						...
						} else if (this_val._is_ended < 0) { // this thread
																// has already
																// ended by
																// exception
					...
					Thread.create = function(f /* , ... */) {
						...
						if (typeof f.$Concurrent_Thread_compiled !== "function")
							f = this.compile(f);
						return f.async(null, Array.prototype.slice.call(
					...
					Thread.sleep.$Concurrent_Thread_compiled = function(
							this_val, args, cont) {
						return {
							continuation : cont,
							ret_val : undefined,
					...
					Thread.stop.$Concurrent_Thread_compiled = function(
							this_val, args, cont) {
						return {
							continuation : cont,
							ret_val : undefined,
					...
					Thread.yield.$Concurrent_Thread_compiled = function(
							this_val, args, cont) {
						return {
							continuation : cont,
							ret_val : undefined,
					...
					var KillException = Thread.KillException = Exception
							.extend(function($super, message) {
										$super(message);
									}, {
										name : NAMESPACE
												+ ".Thread.KillException",
					...
					proto.apply.$Concurrent_Thread_compiled = function(
							this_val, args, cont) {
						if (typeof this_val.$Concurrent_Thread_compiled == "function") {
							return this_val.$Concurrent_Thread_compiled(
									args[0], args[1], cont);
						} else {
							return {
								continuation : cont,
					...
					proto.call.$Concurrent_Thread_compiled = function(this_val,
							args, cont) {
						if (typeof this_val.$Concurrent_Thread_compiled == "function") {
							return this_val.$Concurrent_Thread_compiled(
					...
					proto.async = function(this_val, args) {
						...
						if (args === void 0)
							args = []; // IE6 does not allow null or
										// undefined-value as the second
										// argument of Function.prototype.apply.
										// That does not conform to ECMA262-3!
						return new THREAD(this.$Concurrent_Thread_compiled(
										this_val, args, initial_continuation));
					};
...
(function() {
	...
	if (!this.Data.Cons
			|| (typeof this.Data.Cons != 'object' && typeof this.Data.Cons != 'function'))
		this.Data.Cons = new Object();
	if (!this.Data.Cons.Util
			|| (typeof this.Data.Cons.Util != 'object' && typeof this.Data.Cons.Util != 'function'))
			...
			with (Data.Cons) {
				with (Data.Cons.Util) {
					...
					return function() {
						 ...
						 * The Initial Developer of the Original Code is Daisuke
						 * Maki. Portions created by the Initial Developer are
						 * Copyright (C) 2007 the Initial Developer. All Rights
						 * Reserved.
						 * 
						 * Contributor(s):
						 * 
	...
	with (function() {
		with (Concurrent.Thread.Compiler.Kit) {
			...
			return function() {
				 ...
				 * Communications Corporation. Portions created by the Initial
				 * Developer are Copyright (C) 1997-1999 the Initial Developer.
				 * All Rights Reserved.
				 * 
				 ...
				 * later (the "GPL"), in which case the provisions of the GPL
				 * are applicable instead of those above. If you wish to allow
				 * use of your version of this file only under the terms of the
				 * GPL and not to allow others to use your version of this file
				 * under the MPL, indicate your decision by deleting the
				 * provisions above and replacing them with the notice and other
				...
				function codeBug( /* variable arguments */) {
					...
					for (var i = 0; i < arguments.length; i++)
						str += arguments[i];
					var e = new Data.Error.IllegalStateError("FAILED ASSERTION: "
							+ str);
					var s = e.toString();
					if (e.stack)
						s += "\n----------\n" + e.stack;
				...
				with (Data.Functional) {
					with (Concurrent.Thread.Compiler) {
						...
						return function() {
							 ...
							 * The Initial Developer of the Original Code is
							 * Daisuke Maki. Portions created by the Initial
							 * Developer are Copyright (C) 2006-2007 the Initial
							 * Developer. All Rights Reserved.
							 * 
							 * Contributor(s):
							 * 
							...
							proto.contains = function( /* variable arguments */) {
								for (var i = 0; i < arguments.length; i++) {
									...
									if (!(id instanceof Identifier))
										throw new TypeError("arguments[" + i
												+ "] is not of type Identifier");
									// Because "hasOwnProperty" itself can be
									// used as identifier,
									// we need to avoid
									// "this._set.hasOwnProperty".
									if (!hasOwnProperty.call(this._set, id
													.valueOf()))
										return false;
								}
								return true;
							...
							proto.next = function() {
								...
								return new IdIterator(this._parent,
										this._elems, this._index + 1);
							};
		...
		with (Data.Error) {
			with (Concurrent.Thread.Continuation) {
				...
				return function() {
					 ...
					 * The Initial Developer of the Original Code is Daisuke
					 * Maki. Portions created by the Initial Developer are
					 * Copyright (C) 2008 the Initial Developer. All Rights
					 * Reserved.
					 * 
					 * Contributor(s):
					 * 
					...
					function callcc() {
						throw new Error("can't call `" + NAMESPACE
								+ ".callcc' in non-threaded functions");
					}

					callcc.$Concurrent_Thread_compiled = function($this, $args,
							$cont) {
						function continuation() {
							throw new Error("can't call any captured continuation in non-threaded functions");
						}
						continuation.$Concurrent_Thread_compiled = function(
								$this, $args, _) {
							return {
								continuation : $cont,
								timeout : void 0,
						...
						var f = $args[0];
						return f
								&& typeof f.$Concurrent_Thread_compiled === "function"
								? f.$Concurrent_Thread_compiled(null,
										[continuation], $cont)
								: {
									continuation : $cont,
					...
					function getCC() {
						throw new Error("can't call `" + NAMESPACE
								+ ".getCC' in non-threaded functions");
					}

					getCC.$Concurrent_Thread_compiled = function($this, $args,
							$cont) {
						function continuation() {
							throw new Error("can't call any captured continuation in non-threaded functions");
						}
					...
					function currentContinuation() {
						throw new Error("can't call `"
								+ NAMESPACE
								+ ".currentContinuation' in non-threaded functions");
					}

					currentContinuation.$Concurrent_Thread_compiled = function(
							$this, $args, $cont) {
						function continuation() {
							throw new Error("can't call any captured continuation in non-threaded functions");
						}
	...
	with (function() {
		with (Concurrent.Thread.Compiler) {
			...
			return function() {
				...
				/**
				 * This file is based on the file ErrorReporter.java in Rhino
				 * 1.6R5.
				 */
				...
				function ErrorReporter() {
					// This is kind of abstract class.
					// It provides null-implementations for the methods as
					// default.
				}
				 ...
				 * Report a warning.
				 * 
				 * The implementing class may choose to ignore the warning if it
				 * desires.
				 * 
				 * @param message
				 ...
				 * @param lineOffset
				 *            the offset into lineSource where problem was
				 *            detected
				 */
				 ...
				 * Report an error.
				 * 
				 * The implementing class is free to throw an exception if it
				 * desires.
				 * 
				 * If execution has not yet begun, the JavaScript engine is free
				 * to find additional errors rather than terminating the
				 * translation. It will not execute a script that had errors,
				 * however.
				 * 
				 * @param message
			...
			return function() {
				...
				function isSpace(c) {
					...
					if (c <= 255) {
						...
						// the following code is derived from the Unicode
						// category Zs based on:
						// http://www.unicode.org/Public/UNIDATA/extracted/DerivedGeneralCategory.txt
						// #generated# Last update: Tue, 01 Aug 2006 01:57:18
						// +0900
						return c <= 0x180E ? c <= 0xA0 ? c <= 0x20
								? 0x20 <= c
								: 0xA0 <= c : c <= 0x1680
								? 0x1680 <= c
								: 0x180E <= c : c <= 0x202F ? c <= 0x200A
								? 0x2000 <= c
								: 0x202F <= c : c <= 0x205F
								? 0x205F <= c
								: c === 0x3000;
				...
				function isFormatChar(c) {
					...
					// the following code is derived from the Unicode category
					// Cf based on:
					// http://www.unicode.org/Public/UNIDATA/extracted/DerivedGeneralCategory.txt
					// #generated# Last update: Tue, 01 Aug 2006 01:50:39 +0900
					return c <= 0x202E ? c <= 0x70F
							? c <= 0x603
									? c <= 0xAD ? 0xAD <= c : 0x600 <= c
									: c <= 0x6DD ? 0x6DD <= c : 0x70F <= c
							: c <= 0x200F ? c <= 0x17B5
									? 0x17B4 <= c
									: 0x200B <= c : 0x202A <= c : c <= 0xFFFB
							? c <= 0x206F ? c <= 0x2063
									? 0x2060 <= c
									: 0x206A <= c : c <= 0xFEFF
									? 0xFEFF <= c
				...
				function isIdentifierStart(c) {
					...
					// the following code is derived from the Unicode category
					// Lu, Ll, Lt, Lm, Lo, and Nl based on:
					// http://www.unicode.org/Public/UNIDATA/extracted/DerivedGeneralCategory.txt
				...
				function isIdentifierPart(c) {
					...
					// the following code is derived from the Unicode category
					// Lu, Ll, Lt, Lm, Lo, Nl, Mn, Mc, Nd, and Pc based on:
					// http://www.unicode.org/Public/UNIDATA/extracted/DerivedGeneralCategory.txt
		...
		with (Concurrent.Thread.Http) {
			...
			return function() {
					...
					try {
						...
						try {
							...
							throw new Error(NAMESPACE
									+ ": can't load XMLHttpRequest object");
						}
					}
				}
				...
				function send(method, url, body, headers) {
					throw new Error(NAMESPACE
							+ ".send is unusable in non-compiled function");
				}
				...
				send.$Concurrent_Thread_compiled = function($this, $args, $cont) {
					...
					req.send(body); // Firefox occasionally causes "onload"
									// event here. Maybe, it occurs in case of
									// cache-hit.
					cache_hit = false;
					if (loaded) {
						return {
						...
						var ex_handler = {
							procedure : function(e) {
								if (e === LoadedException) {
									...
									} // IE less than 7 does not support
										// "abort".
									return {
										continuation : $cont.exception,
										ret_val : e,
						...
						ex_handler.exception = ex_handler; // Cyclic reference
															// assures to abort
															// request.
						return {
							timeout : -1,
				...
				function get(url, headers) {
					throw new Error(NAMESPACE
							+ ".get is unusable in non-compiled function");
				}

				get.$Concurrent_Thread_compiled = function($this, $args, $cont) {
					return send.$Concurrent_Thread_compiled(null, ["GET",
									$args[0], $args[1], null], $cont);
				}

				function post(url, body, headers) {
					throw new Error(NAMESPACE
							+ ".post is unusable in non-compiled function");
				}
				...
				post.$Concurrent_Thread_compiled = function($this, $args, $cont) {
					...
					if (typeof body == "object") {
						...
						for (var i in body) {
							if (body.hasOwnProperty(i)) {
								vals.push(encodeURIComponent(i) + "="
					...
					if (!content_type_exists) {
						headers = headers.concat("Content-type",
								"application/x-www-form-urlencoded");
					}
					return send.$Concurrent_Thread_compiled(null, ["POST", url,
									body, headers], $cont);
				};
				...
				with (Concurrent) {
					with (Concurrent.Thread) {
						...
						return function() {
							 ...
							 * The Initial Developer of the Original Code is
							 * Daisuke Maki. Portions created by the Initial
							 * Developer are Copyright (C) 2008 the Initial
							 * Developer. All Rights Reserved.
							 * 
							 * Contributor(s):
							 * 
							...
							proto.acquire.$Concurrent_Thread_compiled = function(
									$this, $args, $cont) {
							...
							proto.release = function() {
								...
								if (!this._waiting.isEmpty()) {
									this._waiting.head().value()
											.notify(releasedException);
								}
							};
		...
		with (Data.Cons) {
			with (Concurrent.Thread.Compiler) {
				...
				return function() {
					...
					proto.toString = function() {
						Kit
								.codeBug("Unimplemented method `toString' of class: "
										+ this.constructor);
					};

					proto.containsFunctionCall = function() {
						Kit
								.codeBug("Unimplemented method `containsFunctionCall' of class: "
										+ this.constructor);
					};

					proto.hasSideEffect = function() {
						Kit
								.codeBug("Unimplemented method `hasSideEffect' of class: "
										+ this.constructor);
					};
					...
					function UnaryExpression(e) {
						// This is kind of abstract class and should not be
						// instantiated directly.
						// It just provides default implementations of methods
						// and constructor.
					...
					proto.hasSideEffect = function() {
						return this.left.hasSideEfect()
								|| this.right.hasSideEffect();
					};
					...
					function ObjectInitializer(v) {
						this.pairs = v; // array of {prop: Identifier or
					...
					proto.toString = function() {
						...
						for (var i = 0; i < this.pairs.length; i++) {
							buf.push(String(this.pairs[i].prop) + ":"
									+ String(this.pairs[i].exp));
						}
						return "{" + buf.join(", ") + "}";
					};
					...
					function AssignExpression(left, right) {
						// This is kind of interface. It just represents a set
						// of classes.
						BinaryExpression.apply(this, arguments);
					}
	...
	with (function() {
		with (Concurrent.Thread.Compiler) {
			...
			return function() {
				 ...
				 * All Rights Reserved.
				 * 
				 * Contributor(s): Roger Lawrence Mike McCabe Igor Bukanov Milen
				 * Nankov Daisuke Maki
				 * 
				 * Alternatively, the contents of this file may be used under
				 * the terms of the GNU General Public License Version 2 or
				...
				Token.BINDNAME = 48;
				Token.THROW = 49;
				Token.RETHROW = 50; // rethrow caught execetion: catch (e if )
									// use it
				Token.IN = 51;
				Token.INSTANCEOF = 52;
				Token.LOCAL_LOAD = 53;
				...
				Token.ENUM_ID = 60;
				Token.THISFN = 61;
				Token.RETURN_RESULT = 62; // to return prevoisly stored return
											// result
				...
				Token.REF_SPECIAL = 69; // reference for special properties like
										// __proto
				...
				Token.REF_NS_MEMBER = 74; // Reference for x.ns::y, x..ns::y
											// etc.
				...
				/*
				 * types used for the parse tree - these never get returned by
				 * the scanner.
				 */
				...
				Token.DOTQUERY = 142; // .() -- e.g., x.emps.emp.(name ==
										// "terry")
				Token.XMLATTR = 143; // @
				Token.XMLEND = 144;
			...
			with (Concurrent.Thread.Compiler) {
				...
				return function() {
					...
					function Statement(labels, lineno, source) {
						// This is kind of abstract class.
						this.labels = labels; // array of Identifier # labels
												// directly qualifying this
												// statement
					...
					function VarStatement(labels, decls, lineno, source) {
						Statement.call(this, labels, lineno, source);
						this.decls = decls; // array of {id: Identifier, exp:
											// Expression or null}
					}
						...
						for (var i = 0; i < this.decls.length; i++) {
							if (this.decls[i].exp) {
								buf.push([this.decls[i].id, "=",
										this.decls[i].exp].join(""));
							} else {
								buf.push(this.decls[i].id);
							}
						}
						return [labelsToString.call(this), "var ",
								buf.join(", "), ";",].join("");
					};
					...
					proto.containsFunctionCall = function() {
						for (var i = 0; i < this.decls.length; i++) {
							if (this.decls[i].exp
									&& this.decls[i].exp.containsFunctionCall()) {
								return true;
							}
						}
						return false;
					...
					proto.toString = function() {
						return [labelsToString.call(this), "if (", this.cond,
								") ", this.body].join("");
					};

					function IfElseStatement(labels, cond, tbody, fbody,
							lineno, source) {
						Statement.call(this, labels, lineno, source);
						this.cond = cond; // Expression
					...
					proto.toString = function() {
						return [labelsToString.call(this), "do ", this.body,
								" while (", this.cond, ");"].join("");
					};
					...
					proto.toString = function() {
						return [labelsToString.call(this), "while (",
								this.cond, ") ", this.body].join("");
					};

					function ForStatement(labels, init, cond, incr, body,
							lineno, source) {
						Statement.call(this, labels, lineno, source);
					...
					proto.toString = function() {
						return [labelsToString.call(this), "for (",
								this.init ? this.init : "", "; ",
								this.cond ? this.cond : "", "; ",
								this.incr ? this.incr : "", ") ", this.body]
								.join("");
					};

					function ForVarStatement(labels, decls, cond, incr, body,
							lineno, source) {
						Statement.call(this, labels, lineno, source);
						this.decls = decls; // array of {id: Identifier, exp:
											// Expression or null}
					...
					proto.toString = function() {
						return [
								...
								"for (",
								(this.decls.length ? new VarStatement([],
										this.decls) : ";"), " ",
								this.cond ? this.cond : "", "; ",
								this.incr ? this.incr : "", ") ", this.body]
								.join("");
					...
					function ForInStatement(labels, lhs, exp, body, lineno,
							source) {
						Statement.call(this, labels, lineno, source);
						this.lhs = lhs; // Identifier or DotAccessor or
										// BracketAccessor
						this.exp = exp; // Expression
						this.body = body; // Statement
					}
					...
					proto.toString = function() {
						return [labelsToString.call(this), "for (", this.lhs,
								" in ", this.exp, ") ", this.body].join("");
					};

					function ForInVarStatement(labels, decl, exp, body, lineno,
							source) {
						Statement.call(this, labels, lineno, source);
						this.decl = decl; // {id: Identifier, exp: Expression
											// or null}
						this.exp = exp; // Expression
						this.body = body; // Statement
					}
					...
					proto.toString = function() {
						return [
								...
								this.decl.exp
										? String(this.decl.id) + "="
												+ String(this.decl.exp)
										: String(this.decl.id), " in ",
								this.exp, ") ", this.body].join("");
					};
					...
					proto.toString = function() {
						return [labelsToString.call(this), "for each (",
								this.lhs, " in ", this.exp, ") ", this.body]
								.join("");
					};

					function ForEachVarStatement(labels, decl, exp, body,
							lineno, source) {
						Statement.call(this, labels, lineno, source);
						this.decl = decl; // {id: Identifier, exp: Expression
											// or null}
					...
					proto.toString = function() {
						return [labelsToString.call(this), "return ",
								this.exp ? this.exp : "", ";"].join("");
					};
					...
					function SwitchStatement(labels, exp, clauses, lineno,
						...
						Statement.call(this, labels, lineno, source);
						this.exp = exp; // Expression
						this.clauses = clauses; // cons-list of (CaseClause or
												// DefaultClause)
					}
					...
					proto.toString = function() {
						return [labelsToString.call(this), "throw ", this.exp,
								";"].join("");
					};

					function TryCatchStatement(labels, tryBlock, variable,
							catchBlock, lineno, source) {
						Statement.call(this, labels, lineno, source);
					...
					proto.toString = function() {
						return [labelsToString.call(this), "try ",
								this.tryBlock, "\n", "catch (", this.variable,
								") ", this.catchBlock].join("");
					};

					function TryFinallyStatement(labels, tryBlock,
							finallyBlock, lineno, source) {
						Statement.call(this, labels, lineno, source);
						this.tryBlock = tryBlock; // Block
					...
					proto.toString = function() {
						return [labelsToString.call(this), "try ",
								this.tryBlock, "\n", "finally ",
								this.finallyBlock].join("");
					};

					function TryCatchFinallyStatement(labels, tryBlock,
							variable, catchBlock, finallyBlock, lineno, source) {
						Statement.call(this, labels, lineno, source);
						this.tryBlock = tryBlock; // Block
						this.variable = variable; // Identifier
						this.catchBlock = catchBlock; // Block
					...
					function TryCatchListStatement(labels, tryBlock, catchList,
							lineno, source) {
						Statement.call(this, labels, lineno, source);
						this.tryBlock = tryBlock; // Block
					...
					proto.toString = function() {
						var buf = [labelsToString.call(this), "try ",
								this.tryBlock, "\n"];
					...
					function TryCatchListFinallyStatement(labels, tryBlock,
							catchList, finallyBlock, lineno, source) {
						Statement.call(this, labels, lineno, source);
						this.tryBlock = tryBlock; // Block
						this.catchList = catchList; // cons-list of CatchGuard
						this.finallyBlock = finallyBlock; // Block
					...
					function CatchGuard(variable, cond, block, lineno, source) {
						this.variable = variable; // Identifier
						this.cond = cond; // Expression or null (null means
											// this is default catch clause)
					...
					function FunctionDeclaration(labels, name, params, body,
							lineno, source) {
						Statement.call(this, labels, lineno, source);
	...
	with (function() {
		with (Concurrent.Thread.Compiler) {
			...
			return function() {
				 ...
				 * All Rights Reserved.
				 * 
				 * Contributor(s): Roger Lawrence Mike McCabe Igor Bukanov Ethan
				 * Hugg Terry Lucas Milen Nankov Daisuke Maki
				 * 
				 * Alternatively, the contents of this file may be used under
				 * the terms of the GNU General Public License Version 2 or
				 * later (the "GPL"), in which case the provisions of the GPL
				...
				/**
				 * This file is based on the file TokenStream.java in Rhino
				 * 1.6R5.
				 */
				...
				/*
				 * For chars - because we need something out-of-range to check.
				 * (And checking EOF by exception is annoying.) Fortunatelly,
				 * U+FFFF is guaranteed not to be assigned for any character.
				 ...
				 * TokenStream; if getToken has been called since the passed
				 * token was scanned, the op or string printed may be incorrect.
				 */
				...
				function stringToKeyword(name) {
					return strIdMap.hasOwnProperty(name)
							? strIdMap[name]
							: Token.EOF;
				}
					...
					retry : for (;;) {
						...
						if (identifierStart) {
							...
							for (;;) {
								if (isUnicodeEscapeStart) {
									// strictly speaking we should probably
									// push-back
									// all the bad characters if the
									// <backslash>uXXXX
									// sequence is malformed. But since there
									// isn't a
									// correct context(is there?) for a bad
									// Unicode
									// escape sequence in an identifier, we can
									// report
									// an error here.
									for (var i = 0; i != 4; ++i) {
										c = this.getChar();
							...
							if (!containsEscape) {
								...
								// Return the corresponding token if it's a
								// keyword
						...
						if (isDigit(c)
							...
							if (base === 16) {
								...
								while (isDigit(c)) {
									/*
									 * We permit 08 and 09 as decimal numbers,
									 * which makes our behavior a superset of
									 * the ECMA numeric grammar. We might not
									 * always be so permissive, so we warn about
									 * it.
									 */
									if (base === 8 && (c === '8' || c === '9')) {
							...
							while (c !== quoteChar) {
								...
								if (c === '\\') {
									...
									if (c === '\n') {
										...
										// But, issue warning since ECMA262-3
										// does not allow that.
										this.parser
												.addWarning("msg.unsafe.string.lit");
									} else {
										this.addToString(c);
									}
								} else {
						...
						switch (c.charCodeAt(0)) {
							...
							case 0x3C : // '<'
								/*
								 * NB:treat HTML begin-comment as
								 * comment-till-eol
								 */
								if (this.matchChar('!')) {
									if (this.matchChar('-')) {
				...
				/**
				 * Parser calls the method when it gets / or /= in literal
				 * context.
				 */
				...
				proto.getNextXMLToken = function() {
					...
					for (var c = this.getChar(); c !== EOF_CHAR; c = this
							.getChar()) {
						if (this.xmlIsTagContent) {
							switch (c.charCodeAt(0)) {
								...
								case 0x20 : // ' '
								case 0x09 : // '\t'
									// case 0x0D: // '\r' CR never comes here
					...
					for (var c = this.getChar(); c !== EOF_CHAR;) {
						...
						if (c === '-' && this.matchChar('-')) {
							...
							if (this.matchChar('>')) {
								...
								// Strictly, XMLComment MUST NOT include the
								// sequence "--".
								// So, if the program execution is here, the
								// source is
								// syntactically wrong, according to ECMA367.
								// However, we
								// allow the sequence here, so that our syntax
								// is super-set
				...
				proto.ungetChar = function(c) {
					...
					if (this.ungetBuffer.length
							&& this.ungetBuffer[this.ungetBuffer.length - 1] == '\n')
						Kit.codeBug();
			...
			with (Data.Cons) {
				with (Concurrent.Thread.Compiler.IntermediateLanguage) {
					...
					return function() {
						 ...
						 * The Initial Developer of the Original Code is Daisuke
						 * Maki. Portions created by the Initial Developer are
						 * Copyright (C) 2006-2007 the Initial Developer. All
						 * Rights Reserved.
						 * 
						 * Contributor(s):
						 * 
						...
						function Block(scopes, body, target, exception) {
							...
							this.body = body; // <Statement>
							this.target = target; // Block | "return" |
													// "throw"
							this.exception = exception; // Block | "return" |
														// "throw"
						}
						...
						proto.toString = function() {
							Kit.codeBug('"toString" is not implemented for ',
									this.constructor);
						};

						proto.appendStatement = function( /*
															 * variable
															 * arguments
															 */) {
							var args = arguments;
						...
						proto.prependStatement = function( /*
															 * variable
															 * arguments
															 */) {
							for (var i = arguments.length - 1; i >= 0; i--) {
						...
						proto.toString = function() {
							return [this.id, "([", this.scopes.join(", "),
						...
						function CallBlock(scopes, body, this_val, func, args,
								target, exception) {
							Block.call(this, scopes, body, target, exception);
						...
						proto.toString = function() {
							return [this.id, "([", this.scopes.join(", "),
									...
									this.body.join("\n").replace(/^/mg, "  "),
									"\n", "  call ", this.this_val, ".",
									this.func, "(", this.args.join(", "),
									") -> ", stringify(this.target), "\n", "}"]
									.join("");
						};

						function NewBlock(scopes, body, func, args, target,
								exception) {
							Block.call(this, scopes, body, target, exception);
							this.func = func; // Expression
							this.args = args; // [Expression]
						...
						proto.toString = function() {
							return ["if ", this.cond, " -> ",
									stringify(this.target), ";"].join("");
						};

						function RecvStatement(a) {
							this.assignee = a; // Identifier | DotAccessor |
												// BracketAccessor
						}
						...
						proto.toString = function() {
							return ["enum ", this.assignee, " <- ", this.exp,
									";"].join("");
						};
			...
			with (Concurrent.Thread.Compiler) {
				...
				return function() {
					...
					Statement.prototype[Css] = function() {
						Kit.codeBug("unimplemented '" + Css + "' method for: "
								+ this);
					};
					...
					Block.prototype[Css] = function() {
						...
						return new Block(this.labels, head.cdr, this.lineno,
								this.source);
					};

					ExpStatement.prototype[Css] = function() {
						return new ExpStatement(this.labels, this.exp[Css](),
					...
					VarStatement.prototype[Css] = function() {
						...
						for (var i = 0; i < this.decls.length; i++) {
							decls[i] = {
								id : this.decls[i].id,
								exp : this.decls[i].exp
										? this.decls[i].exp[Css]()
										: null
							};
						}
						return new VarStatement(this.labels, decls,
								this.lineno, this.source);
					};

					IfStatement.prototype[Css] = function() {
						return new IfStatement(this.labels, this.cond[Css](),
								this.body[Css](), this.lineno, this.source);
					};

					IfElseStatement.prototype[Css] = function() {
						return new IfElseStatement(this.labels,
								this.cond[Css](), this.tbody[Css](),
								this.fbody[Css](), this.lineno, this.source);
					};

					DoWhileStatement.prototype[Css] = function() {
						return new DoWhileStatement(this.labels,
								this.body[Css](), this.cond[Css](),
								this.lineno, this.source);
					};

					WhileStatement.prototype[Css] = function() {
						return new WhileStatement(this.labels,
								this.cond[Css](), this.body[Css](),
								this.lineno, this.source);
					};

					ForStatement.prototype[Css] = function() {
						return new ForStatement(this.labels, this.init
										? this.init[Css]()
										: null, this.cond
										? this.cond[Css]()
										: null, this.incr
										? this.incr[Css]()
										: null, this.body[Css](), this.lineno,
								this.source);
					};
					...
					ForVarStatement.prototype[Css] = function() {
						...
						return new ForVarStatement(this.labels, decls,
								this.cond ? this.cond[Css]() : null, this.incr
										? this.incr[Css]()
										: null, this.body[Css](), this.lineno,
								this.source);
					};
					...
					ForInStatement.prototype[Css] = function() {
						return new ForInStatement(this.labels, this.lhs[Css](),
								this.exp[Css](), this.body[Css](), this.lineno,
								this.source);
					};
					...
					ForInVarStatement.prototype[Css] = function() {
						...
						return new ForInVarStatement(this.labels, decl,
								this.exp[Css](), this.body[Css](), this.lineno,
								this.source);
					};

					ForEachStatement.prototype[Css] = function() {
						return new ForEachStatement(this.labels,
								this.lhs[Css](), this.exp[Css](),
								this.body[Css](), this.lineno, this.source);
					};
					...
					ForEachVarStatement.prototype[Css] = function() {
						...
						return new ForEachVarStatement(this.labels, decl,
								this.exp[Css](), this.body[Css](), this.lineno,
								this.source);
					};
					...
					ReturnStatement.prototype[Css] = function() {
						if (!this.exp)
							return this;
						return new ReturnStatement(this.labels,
								this.exp[Css](), this.lineno, this.source);
					};

					WithStatement.prototype[Css] = function() {
						return new WithStatement(this.labels, this.exp[Css](),
								this.body[Css](), this.lineno, this.source);
					};
					...
					SwitchStatement.prototype[Css] = function() {
						...
						return new SwitchStatement(this.labels,
								this.exp[Css](), head.cdr, this.lineno,
								this.source);
					};
					...
					CaseClause.prototype[Css] = function() {
						...
						return new CaseClause(this.exp[Css](), head.cdr,
								this.lineno, this.source);
					};
					...
					DefaultClause.prototype[Css] = function() {
						...
						return new DefaultClause(head.cdr, this.lineno,
								this.source);
					};

					ThrowStatement.prototype[Css] = function() {
						return new ThrowStatement(this.labels, this.exp[Css](),
								this.lineno, this.source);
					};

					TryCatchStatement.prototype[Css] = function() {
						return new TryCatchStatement(this.labels,
								this.tryBlock[Css](), this.variable,
								this.catchBlock[Css](), this.lineno,
								this.source);
					};

					TryFinallyStatement.prototype[Css] = function() {
						return new TryFinallyStatement(this.labels,
								this.tryBlock[Css](), this.finallyBlock[Css](),
								this.lineno, this.source);
					};

					TryCatchFinallyStatement.prototype[Css] = function() {
						return new TryCatchFinallyStatement(this.labels,
								this.tryBlock[Css](), this.variable,
								this.catchBlock[Css](),
								this.finallyBlock[Css](), this.lineno,
								this.source);
					};
					...
					TryCatchListStatement.prototype[Css] = function() {
						if (this.catchList.isNil()) { // no more catch-guard
							...
							return block;
						} else if (this.catchList.car.cond) { // one or more
																// qualified
																// catch-guard
									...
									new Block(
											...
											list(	new IfElseStatement(
															...
															(new TryCatchListStatement(
																	...
																	new Block(
																			[],
																			list(new ThrowStatement(
																					[],
																					guard.variable))),
																	this.catchList.cdr,
																	this.catchList.cdr.lineno,
																	this.cdr.cdr.source))[Css](),
															guard.lineno,
															guard.source))));
						} else { // (only one) default catch-guard
							var guard = this.catchList.car;
							return new TryCatchStatement(this.labels,
									this.tryBlock[Css](), guard.variable,
									guard.block[Css](), this.lineno,
									this.source);
						}
					};
					...
					TryCatchListFinallyStatement.prototype[Css] = function() {
						return new TryFinallyStatement(this.labels,
								new Block([], list((new TryCatchListStatement(
														[], this.tryBlock,
														this.catchList,
														this.lineno,
														this.source))[Css]()),
					...
					FunctionDeclaration.prototype[Css] = function() {
						...
						return new FunctionDeclaration(this.labels, this.name,
								this.params, head.cdr, this.lineno, this.source);
					};
					...
					BinaryExpression.prototype[Css] = function() {
						return new this.constructor(this.left[Css](),
								this.right[Css]());
					};
					...
					ConditionalExpression.prototype[Css] = function() {
						return new ConditionalExpression(this.cond[Css](),
								this.texp[Css](), this.fexp[Css]());
					};
				...
				with (Data.Error) {
					with (Concurrent.Thread.Compiler) {
						...
						return function() {
							 ...
							 * rights and limitations under the License.
							 * 
							 * The Original Code is Rhino code, released May 6,
							 * 1999.
							 * 
							 * The Initial Developer of the Original Code is
							 * Netscape Communications Corporation. Portions
							 * created by the Initial Developer are Copyright
							 * (C) 1997-1999 the Initial Developer. All Rights
							 * Reserved.
							 * 
							 * Contributor(s): Mike Ang Igor Bukanov Yuh-Ruey
							 * Chen Ethan Hugg Terry Lucas Mike McCabe Milen
							 * Nankov Daisuke Maki
							 * 
							 * Alternatively, the contents of this file may be
							 * used under the terms of the GNU General Public
							 * License Version 2 or later (the "GPL"), in which
							 * case the provisions of the GPL are applicable
							 * instead of those above. If you wish to allow use
							 * of your version of this file only under the terms
							 * of the GPL and not to allow others to use your
							 * version of this file under the MPL, indicate your
							 * decision by deleting the provisions above and
							 * replacing them with the notice and other
							 * provisions required by the GPL. If you do not
							 * delete the provisions above, a recipient may use
							 * your version of this file under either the MPL or
							 * the GPL.
							 * 
							 * ***** END LICENSE BLOCK *****
							 */
							...
							/**
							 * This file is based on the file Parser.java in
							 * Rhino 1.6R5.
							 */

							NAMESPACE = 'Concurrent.Thread.Compiler';

							// TokenInformation flags : flaggedTokenBuffer
							// stores them together
							// with token type
							var CLEAR_TI_MASK = 0xFFFF; // mask to clear token
														// information bits
							var TI_AFTER_EOL = 1 << 16; // first token of the
														// source line
							var TI_CHECK_LABEL = 1 << 17; // indicates to
															// check for label

							// Exception to unwind
							var ParserException = Exception.extend(function(
											$super, message) {
										$super(message);
									}, {
							...
							defaultReporter.error = function(message, line,
							...
							function Parser(errorReporter) {
								...
								// The following are per function variables and
								// should be saved/restored
								// during function parsing.
								this.nestingOfLoop = 0;
								this.nestingOfSwitch = 0;
								this.allLabelSet = null; // contains all
															// labels in current
															// scope
								this.loopLabelSet = null; // contains only
															// labels qualifying
															// IterationStatement
															// in current scope
							}
							...
							proto.getMessage = function(messageId /*
																	 * optional
																	 * args
																	 */) {
								// !! fake implementation
							...
							proto.addWarning = function(messageId /*
																	 * optional
																	 * args
																	 */) {
								this.errorReporter.warning(this.getMessage
												.apply(this, arguments),
										this.ts.getLineno(), this.ts.getLine(),
										this.ts.getOffset());
							};

							proto.addError = function(messageId /* optional args */) {
								++this.syntaxErrorCount;
								this.errorReporter.error(this.getMessage.apply(
												this, arguments), this.ts
												.getLineno(),
										this.ts.getLine(), this.ts.getOffset());
							};

							proto.reportError = function(messageId /*
																	 * optional
																	 * args
																	 */) {
								this.addError.apply(this, arguments);
								// Throw a ParserException exception to unwind
							...
							proto.peekTokenOrEOL = function() {
								...
								if (this.flaggedTokenBuffer.peek()
										& TI_AFTER_EOL)
									return Token.EOL;
								return tt;
							};

							// Since we need to backtrack to properly parse
							...
							proto.mustMatchToken = function(toMatch, messageId /*
																				 * optional
																				 * args
																				 */) {
							...
							proto.parse = function(sourceString, lineno, source) {
								...
								if (this.syntaxErrorCount) {
									...
									throw new SyntaxError(this
											.getMessage("msg.got.syntax.errors"));
								}
							...
							proto.functionDecl = function(labels) {
								var baseLineno = this.ts.getLineno(); // line
																		// number
																		// where
																		// source
																		// starts
								this.mustMatchToken(Token.NAME,
										"msg.no.func.name");
								var name = new Identifier(this.ts.getString());
								var params = this.parameterList();
								var body = this.functionBody();
								return new FunctionDeclaration(labels, name,
										params, body, baseLineno, this.source);
							};
							...
							proto.parameterList = function() {
								...
								this.mustMatchToken(Token.RP,
										"msg.no.paren.after.parms");
								return params;
							};

							proto.functionBody = function() {
								this.mustMatchToken(Token.LC,
										"msg.no.brace.body");
							...
							proto.statementHelper = function(labels) {
								...
								switch (this.peekToken()) {
									case Token.IF : {
										...
										if (this.matchToken(Token.ELSE)) {
											return new IfElseStatement(labels,
													cond, tstat, this
															.statement(),
													lineno, this.source);
										} else {
											return new IfStatement(labels,
													cond, tstat, lineno,
													this.source);
										}
									}
									...
									case Token.WHILE : {
										...
										try {
											return new WhileStatement(labels,
													this.condition(), this
															.statement(),
													lineno, this.source);
										} finally {
									...
									case Token.DO : {
										...
										this.mustMatchToken(Token.WHILE,
												"msg.no.while.do");
										var cond = this.condition();
										// Always auto-insert semicon to follow
										// SpiderMonkey:
										// It is required by EMAScript but is
										// ignored by the rest of
										// world, see bug 238945
										this.matchToken(Token.SEMI);
										return new DoWhileStatement(labels,
												body, cond, lineno, this.source);
									}
									...
									case Token.FOR : {
										...
										var init; // init is also foo in 'foo
													// in Object'
										var cond; // cond is also object in
													// 'foo in Object'
										var incr = null;
										var body;
										...
										// See if this is a for each () instead
										// of just a for ()
										if (this.matchToken(Token.NAME)) {
										...
										if (this.matchToken(Token.IN)) {
											isForIn = true;
											// 'cond' is the object over which
											// we're iterating
											cond = this.expr(false);
										} else { // ordinary for loop
											this.mustMatchToken(Token.SEMI,
													"msg.no.semi.for");
										...
										if (!isForIn) {
											// Although SpiderMonkey doesn't
											// allow "for each ( ...; ...; ...
											// )",
											// Rhino1.6R5 allowed it. We follow
											// Rhino's position here.
											if (isVar)
												...
												return new ForStatement(labels,
														init, cond, incr, body,
														lineno, this.source);
										} else {
											if (isVar) {
												// Check if init (var
												// declarations) contains only
												// one.
												if (init.length != 1)
													this
															.reportError("msg.mult.index");
												if (isForEach)
													return new ForEachVarStatement(
															labels, init[0],
															cond, body, lineno,
															this.source);
												else
													return new ForInVarStatement(
															labels, init[0],
															cond, body, lineno,
															this.source);
											} else {
												// Check if init (an expression
												// left-hand-side of "in") has
												// lvalue.
												if (!init.hasLvalue())
													this
									...
									case Token.TRY : {
										...
										// Although ECMA262-3 requires a block
										// here, Rhino1.6R5 allows any kind of
										// statement.
										// We follow Rhino's style, but issue
										// warning when a statement is not a
										// block.
										var tryBlock = this.statement();
										if (!(tryBlock instanceof Block)) {
											this
													.addWarning("msg.no.brace.tryblock");
											tryBlock = new Block([], cons(
															tryBlock, nil()),
													tryBlock.lineno,
													tryBlock.source);
										}
										...
										if (peek === Token.CATCH) {
											while (this.matchToken(Token.CATCH)) {
												...
												this.mustMatchToken(Token.NAME,
														"msg.bad.catchcond");
												var variable = new Identifier(this.ts
														.getString());
												...
												var clause = new CatchGuard(
														variable, cond, block,
														line, this.source);
												cell = cell.cdr = cons(clause,
														cell.cdr);
											}
										} else if (peek !== Token.FINALLY) {
											this.mustMatchToken(Token.FINALLY,
										...
										if (this.matchToken(Token.FINALLY)) {
											// Rhino also allows any kind of
											// statement here.
											finallyBlock = this.statement();
											if (!(finallyBlock instanceof Block)) {
												this
														.addWarning("msg.no.brace.finallyblock");
										...
										return finallyBlock
												? new TryCatchListFinallyStatement(
														labels, tryBlock,
														catchList,
														finallyBlock, lineno,
														this.source)
									...
									case Token.THROW : {
										...
										if (this.peekTokenOrEOL() === Token.EOL) {
											// ECMAScript does not allow new
											// lines before throw expression,
											// see bug 256617
											this
										...
										var lineno = this.ts.getLineno();
										statement = new ThrowStatement(labels,
												this.expr(false), lineno,
												this.source);
										break;
									}
									...
									case Token.BREAK : {
										...
										var lineno = this.ts.getLineno();
										var target = this
												.matchJumpLabelName(Token.BREAK);
										if (target == null) {
										...
										statement = new BreakStatement(labels,
												target, lineno, this.source);
										break;
									}
									...
									case Token.CONTINUE : {
										...
										var lineno = this.ts.getLineno();
										var target = this
												.matchJumpLabelName(Token.CONTINUE);
										if (target == null) {
											if (!this.nestingOfLoop)
												reportError("msg.continue.outside");
										}
										statement = new ContinueStatement(
												labels, target, lineno,
												this.source);
										break;
									}
									...
									case Token.WITH : {
										...
										var body = this.statement();
										return new WithStatement(labels, exp,
												body, lineno, this.source);
									}

									case Token.VAR : {
										this.consumeToken();
										statement = new VarStatement(labels,
												this.variables(false), lineno,
												this.source);
										break;
									}
									...
									case Token.RETURN : {
										...
										var exp;
										/*
										 * This is ugly, but we don't want to
										 * require a semicolon.
										 */
										...
										statement = new ReturnStatement(labels,
												exp, lineno, this.source);
										break;
									}

									case Token.LC :
										this.consumeToken();
										var block = new Block(labels, this
														.statements(), lineno,
												this.source);
										this.mustMatchToken(Token.RC,
												"msg.no.brace.block");
									...
									case Token.SEMI :
										this.consumeToken();
										return new EmptyStatement(labels,
												lineno, this.source);
									...
									case Token.NAME : {
										...
										try {
											statement = new ExpStatement(
													labels, this.expr(false),
													lineno, this.source);
										} catch (e) {
									...
									default : {
										var lineno = this.ts.getLineno();
										statement = new ExpStatement(labels,
												this.expr(false), lineno,
												this.source);
										break;
									}
								...
								switch (this.peekTokenOrEOL()) {
									...
									case Token.RC :
										...
										break;
									default :
										// Report error if no EOL or autoinsert
										// ; otherwise
							...
							proto.variables = function(inForInit) {
								...
								for (;;) {
									this.mustMatchToken(Token.NAME,
											"msg.bad.var");
									var name = new Identifier(this.ts
											.getString());
							...
							proto.expr = function(inForInit) {
								...
								while (this.matchToken(Token.COMMA)) {
									exp = new CommaExpression(exp, this
													.assignExpr(inForInit));
								}
								return exp;
							};
							...
							proto.assignExpr = function(inForInit) {
								...
								var tt = this.peekToken();
								if (tt < Token.FIRST_ASSIGN
										|| Token.LAST_ASSIGN < tt)
									return exp;
								...
								switch (this.nextToken()) {
									case Token.ASSIGN :
										return new SimpleAssignExpression(exp,
												this.assignExpr(inForInit));
									case Token.ASSIGN_BITOR :
										return new BitOrAssignExpression(exp,
												this.assignExpr(inForInit));
									case Token.ASSIGN_BITXOR :
										return new BitXorAssignExpression(exp,
												this.assignExpr(inForInit));
									case Token.ASSIGN_BITAND :
										return new BitAndAssignExpression(exp,
												this.assignExpr(inForInit));
									case Token.ASSIGN_LSH :
										return new LShiftAssignExpression(exp,
												this.assignExpr(inForInit));
									case Token.ASSIGN_RSH :
										return new RShiftAssignExpression(exp,
												this.assignExpr(inForInit));
									case Token.ASSIGN_URSH :
										return new URShiftAssignExpression(exp,
												this.assignExpr(inForInit));
									case Token.ASSIGN_ADD :
										return new AddAssignExpression(exp,
												this.assignExpr(inForInit));
									case Token.ASSIGN_SUB :
										return new SubAssignExpression(exp,
												this.assignExpr(inForInit));
									case Token.ASSIGN_MUL :
										return new MulAssignExpression(exp,
												this.assignExpr(inForInit));
									case Token.ASSIGN_DIV :
										return new DivAssignExpression(exp,
												this.assignExpr(inForInit));
									case Token.ASSIGN_MOD :
										return new ModAssignExpression(exp,
												this.assignExpr(inForInit));
									default :
										throw Kit.codeBug();
								}
							...
							proto.condExpr = function(inForInit) {
								...
								this.mustMatchToken(Token.COLON,
										"msg.no.colon.cond");
								var ifFalse = this.assignExpr(inForInit);
								return new ConditionalExpression(exp, ifTrue,
										ifFalse);
							};
							...
							proto.andExpr = function(inForInit) {
								...
								while (this.matchToken(Token.AND)) {
									exp = new AndExpression(exp, this
													.bitOrExpr(inForInit));
								}
								return exp;
							};
							...
							proto.bitOrExpr = function(inForInit) {
								...
								while (this.matchToken(Token.BITOR)) {
									exp = new BitOrExpression(exp, this
													.bitXorExpr(inForInit));
								}
								return exp;
							};
							...
							proto.bitXorExpr = function(inForInit) {
								...
								while (this.matchToken(Token.BITXOR)) {
									exp = new BitXorExpression(exp, this
													.bitAndExpr(inForInit));
								}
								return exp;
							};
							...
							proto.bitAndExpr = function(inForInit) {
								...
								while (this.matchToken(Token.BITAND)) {
									exp = new BitAndExpression(exp, this
													.eqExpr(inForInit));
								}
								return exp;
							};
							...
							proto.unaryExpr = function() {
								...
								switch (this.peekToken()) {
									...
									default :
										...
										// Don't look across a newline boundary
										// for a postfix incop.
										switch (this.peekTokenOrEOL()) {
											case Token.INC :
												if (!exp.hasLvalue())
													this
															.reportError("msg.bad.incr");
												this.consumeToken();
												return new PostIncExpression(exp);
											case Token.DEC :
												if (!exp.hasLvalue())
													this
															.reportError("msg.bad.decr");
												this.consumeToken();
							...
							proto.memberExpr = function(allowCallSyntax) {
								...
								if (this.matchToken(Token.NEW)) {
									...
									var args = this.matchToken(Token.LP) ? this
											.argumentList() : [];
									base = new NewExpression(func, args);
								} else {
									base = this.primaryExpr();
								}
								return this.memberExprTail(allowCallSyntax,
										base);
							}

							proto.memberExprTail = function(allowCallSyntax,
									base) {
								tailLoop : for (;;) {
									switch (this.peekToken()) {
										case Token.DOTDOT :
										...
										case Token.DOT : {
											...
											switch (this.nextToken()) {
												case Token.NAME :
													base = new DotAccessor(
															base,
															new Identifier(this.ts
																	.getString()));
													break;
												case Token.MUL :
													this
										...
										case Token.LB :
											this.consumeToken();
											base = new BracketAccessor(base,
													this.expr(false));
											this.mustMatchToken(Token.RB,
							...
							proto.primaryExpr = function() {
								...
								switch (tt) {
									...
									case Token.LC : {
										...
										commaloop : do {
											...
											switch (this.peekToken()) {
												case Token.NAME :
													this.consumeToken();
													prop = new Identifier(this.ts
															.getString());
													break;
												case Token.STRING :
													this.consumeToken();
													prop = new StringLiteral(this.ts
															.getString());
													break;
												case Token.NUMBER :
													this.consumeToken();
													prop = new NumberLiteral(this.ts
															.getString());
													break;
												case Token.RC :
									...
									case Token.NUMBER :
										return new NumberLiteral(this.ts
												.getString());

									case Token.STRING :
										return new StringLiteral(this.ts
												.getString());

									case Token.DIV :
									case Token.ASSIGN_DIV :
										// Got / or /= which should be treated
										// as regexp in fact
										this.ts.readRegExp(tt);
										return new RegExpLiteral(this.ts
												.getString());
									...
									case Token.ERROR :
										/*
										 * the scanner or one of its subroutines
										 * reported the error.
										 */
										break;
					...
					with (Concurrent.Thread) {
						with (Concurrent.Thread.Compiler) {
							...
							return function() {
								 ...
								 * The Initial Developer of the Original Code is
								 * Daisuke Maki. Portions created by the Initial
								 * Developer are Copyright (C) 2006-2007 the
								 ...
								 * License Version 2.1 or later (the "LGPL"), in
								 ...
								 * this file only under the terms of either the
								 * GPL or the LGPL, and not to allow others to
								 * use your version of this file under the terms
								 * of the MPL, indicate your decision by
								 * deleting the provisions above and replace
								 * them with the notice and other provisions
								 * required by the GPL or the LGPL. If you do
								 * not delete the provisions above, a recipient
								 * may use your version of this file under the
								...
								function CfConvert(func) {
									...
									return new IL.Function(func.name,
											func.params, func.vars, body.cdr,
											start);
								}

								function cacheToList(cache) {
									// Resolves exception-dependency and sort
									// blocks in valid order.
									var blocks = [];
									...
									cache.values().forEach(function(it) {
										...
										depends
												.put(
														new Identifier(it.id),
														it.exception instanceof IL.Block
								...
								IL.GotoBlock.prototype[Cf] = function(cache) {
									...
									block.exception = CfTarget(this.exception,
											cache);
									return block;
								};
								...
								ArrayInitializer.prototype[Cf] = function(cache) {
									return new ArrayInitializer(this.elems.map(
											function(it) {
												return it[Cf](cache);
											}));
								};

								FunctionExpression.prototype[Cf] = function(
										cache) {
								...
								ObjectInitializer.prototype[Cf] = function(
										cache) {
									return new ObjectInitializer(this.pairs
											.map(function(it) {
														return {
															prop : it.prop,
															exp : it.exp[Cf](cache)
								...
								DotAccessor.prototype[Cf] = function(cache) {
									return new DotAccessor(
											this.base[Cf](cache), this.prop);
								};
				...
				with (Concurrent.Thread.Compiler) {
					...
					return function() {
						...
						proto.getStackVar = function(n) {
							...
							if (isNaN(n) || n < 0)
								Kit
										.codeBug("must be integer greater than zero");
							for (var i = this.stackVars.length; i <= n; i++) {
								this.stackVars[i] = new Identifier(STACK_VAR
										+ i);
							}
						...
						proto.putBreakAndContinueLabels = function(labels,
						...
						proto.pushScope = function( /* variable args */) {
							return this.scopes.push.apply(this.scopes,
									arguments);
						};
						...
						proto.makeGotoBlock = function(arg, target) {
							return new IL.GotoBlock(this.getScopes(), nil(),
									arg, target, this.contThrow);
						};

						function CsConvert(func) {
							var context = new Context();
							var last_block = new IL.GotoBlock([], nil(),
									undefinedExp, "return", "throw");
							func.body = CsStatements(func.body,
									list(last_block), context, 0);
						...
						function CsStatements(stmts, follows, ctxt, sttop) {
							if (stmts.isNil())
								return follows;
							follows = CsStatements(stmts.cdr, follows, ctxt,
									sttop);
							return stmts.car[Cs](follows, ctxt, sttop);
						}

						function CsReference(exp, ctxt, sttop, rest) { // Expression
																		// ->
																		// Context
																		// ->
																		// Int
							...
							if (exp instanceof DotAccessor) {
								var e = new DotAccessor(
										ctxt.getStackVar(sttop), exp.prop);
								var follows = rest(e, sttop + 1);
								return exp.base[Cs](follows, ctxt, sttop);
							} else if (exp instanceof BracketAccessor) {
								var e = new BracketAccessor(ctxt
												.getStackVar(sttop), ctxt
												.getStackVar(sttop + 1));
								var follows = rest(e, sttop + 2);
								follows = exp.right[Cs](follows, ctxt, sttop
												+ 1);
								return exp.left[Cs](follows, ctxt, sttop);
							} else if (exp instanceof Identifier) {
								return rest(exp, sttop);
							} else {
								var follows = rest(ctxt.getStackVar(sttop),
										sttop + 1);
								return exp[Cs](follows, ctxt, sttop);
							}
						}

						EmptyStatement.prototype[Cs] = function(follows, ctxt,
								sttop) {
							return follows;
						};

						Block.prototype[Cs] = function(follows, ctxt, sttop) {
							var restore = ctxt.putBreakLabels(this.labels,
									follows.car);
							follows = cons(ctxt.makeGotoBlock(undefinedExp,
											follows.car), follows);
							try {
								return CsStatements(this.body, follows, ctxt,
										sttop);
							} finally {
						...
						ExpStatement.prototype[Cs] = function(follows, ctxt,
								sttop) {
							return this.exp[Cs](follows, ctxt, sttop);
						};

						IfStatement.prototype[Cs] = function(follows, ctxt,
								sttop) {
							...
							try {
								...
								follows.car
										.prependStatement(new IL.CondStatement(
												new NotExpression(ctxt
														.getStackVar(sttop)),
												next_block));
						...
						IfElseStatement.prototype[Cs] = function(follows, ctxt,
								sttop) {
							var next_block = follows.car;
							follows = cons(ctxt.makeGotoBlock(undefinedExp,
											next_block), follows);
						...
						DoWhileStatement.prototype[Cs] = function(follows,
								ctxt, sttop) {
							var next_block = follows.car;
							var first_block = ctxt.makeGotoBlock(undefinedExp,
									null);
							follows = cons(ctxt.makeGotoBlock(undefinedExp,
											next_block), follows);
							if (this.cond.containsFunctionCall()) {
								...
								follows.car
										.prependStatement(new IL.CondStatement(
												this.cond, first_block));
							}
							var continue_block = follows.car;
							follows = cons(ctxt.makeGotoBlock(undefinedExp,
											follows.car), follows);
							var restore = ctxt.putBreakAndContinueLabels(
									this.labels.concat(emptyLabel), next_block,
									continue_block);
							try {
								follows = this.body[Cs](follows, ctxt, sttop);
							} finally {
							...
							return cons(ctxt.makeGotoBlock(undefinedExp,
											first_block), cons(first_block,
											follows));
						};

						WhileStatement.prototype[Cs] = function(follows, ctxt,
								sttop) {
							var next_block = follows.car;
							var first_block = ctxt.makeGotoBlock(undefinedExp,
									null);
						...
						ForStatement.prototype[Cs] = function(follows, ctxt,
								sttop) {
							var next_block = follows.car;
							var last_block = ctxt.makeGotoBlock(undefinedExp,
									null);
							follows = cons(last_block, follows);
							if (this.incr)
								follows = this.incr[Cs](follows, ctxt, sttop);
									...
									follows.car
											.prependStatement(new IL.CondStatement(
													new NotExpression(ctxt
															.getStackVar(sttop)),
													next_block));
									follows = this.cond[Cs](follows, ctxt,
											sttop);
								} else {
									follows.car
											.prependStatement(new IL.CondStatement(
						...
						ForInStatement.prototype[Cs] = function(follows, ctxt,
								sttop) {
							if (!this.lhs.hasLvalue())
								Kit
										.codeBug('for-in requires lvalue on the left hand side of "in": '
												+ this);
							var next_block = follows.car;
							var loop_block = ctxt.makeGotoBlock(undefinedExp,
									null);
							follows = cons(ctxt.makeGotoBlock(undefinedExp,
											loop_block), follows);
							var restore = ctxt.putBreakAndContinueLabels(
							...
							if (this.lhs.containsFunctionCall()) {
								follows = CsReference(this.lhs, ctxt,
										sttop + 2, function(exp) {
											follows.car
													.prependStatement(make_assign(
															exp,
															new BracketAccessor(
																	ctxt
																			.getStackVar(sttop),
																	new PostIncExpression(ctxt
																			.getStackVar(sttop
																					+ 1)))));
											return follows;
										});
							...
							follows.car.prependStatement(new IL.CondStatement(
									new GreaterEqualExpression(ctxt
													.getStackVar(sttop + 1),
											new DotAccessor(
													ctxt.getStackVar(sttop),
							...
							follows = cons(ctxt.makeGotoBlock(undefinedExp,
											loop_block), follows);
							follows.car.prependStatement(make_assign(ctxt
											.getStackVar(sttop + 1),
									new NumberLiteral(0)));
							if (this.exp.containsFunctionCall()) {
								follows.car
										.prependStatement(new IL.EnumStatement(
												ctxt.getStackVar(sttop), ctxt
														.getStackVar(sttop)));
						...
						ContinueStatement.prototype[Cs] = function(follows,
								ctxt, sttop) {
							return cons(ctxt.makeGotoBlock(undefinedExp,
											ctxt.contContinue.get(this.target
													? this.target
													: emptyLabel)), follows);
						};

						BreakStatement.prototype[Cs] = function(follows, ctxt,
								sttop) {
							var restore = ctxt.putBreakLabels(this.labels,
									follows.car);
							try {
								return cons(ctxt.makeGotoBlock(undefinedExp,
												ctxt.contBreak.get(this.target
														? this.target
														: emptyLabel)), follows);
							} finally {
								ctxt.contBreak = restore;
						...
						ReturnStatement.prototype[Cs] = function(follows, ctxt,
								sttop) {
							if (this.exp) {
								if (this.exp.containsFunctionCall()) {
									follows = cons(ctxt.makeGotoBlock(
													ctxt.getStackVar(sttop),
													ctxt.contReturn), follows);
									return this.exp[Cs](follows, ctxt, sttop);
								} else {
									return cons(ctxt.makeGotoBlock(this.exp,
													ctxt.contReturn), follows);
								}
							} else {
								return cons(ctxt.makeGotoBlock(undefinedExp,
						...
						WithStatement.prototype[Cs] = function(follows, ctxt,
								sttop) {
							var next_block = follows.car;
							var restore = ctxt.putBreakLabels(this.labels,
									next_block);
							try {
								...
								try {
									follows = cons(ctxt.makeGotoBlock(
													undefinedExp, next_block),
											follows);
									follows = this.body[Cs](follows, ctxt,
											sttop + 1);
								} finally {
									ctxt.popScope();
								}
						...
						SwitchStatement.prototype[Cs] = function(follows, ctxt,
								sttop) {
							var next_block = follows.car;
							var restore = ctxt.putBreakLabels(this.labels
											.concat(emptyLabel), next_block);
							try {
								var default_target = next_block;
								var cond_and_target = this.clauses.reverse()
										.map(function(clause) {
											follows = cons(ctxt.makeGotoBlock(
															undefinedExp,
															follows.car),
													follows);
											follows = CsStatements(clause.body,
													follows, ctxt, sttop);
																...
																new StrictEqualExpression(
																		...
																		ctxt
																				.getStackVar(sttop
																						+ 1)),
																it.target));
										follows = it.cond[Cs](follows, ctxt,
												sttop + 1);
									} else {
										follows.car
												.prependStatement(new IL.CondStatement(
						...
						ThrowStatement.prototype[Cs] = function(follows, ctxt,
								sttop) {
							if (this.exp.containsFunctionCall()) {
								follows = cons(ctxt.makeGotoBlock(ctxt
														.getStackVar(sttop),
						...
						TryCatchStatement.prototype[Cs] = function(follows,
								ctxt, sttop) {
							var next_block = follows.car;
							follows = cons(ctxt.makeGotoBlock(undefinedExp,
											next_block), follows);
							var restore = ctxt.putBreakLabels(this.labels,
									next_block);
							try {
								follows = this.catchBlock[Cs](follows, ctxt,
										sttop);
								follows.car
										.prependStatement(new IL.RecvStatement(this.variable));
								...
								try {
									follows = cons(ctxt.makeGotoBlock(
													undefinedExp, next_block),
											follows);
									return this.tryBlock[Cs](follows, ctxt,
											sttop);
								} finally {
						...
						TryFinallyStatement.prototype[Cs] = function(follows,
								ctxt, sttop) {
							var next_block = follows.car;
							follows = cons(ctxt.makeGotoBlock(undefinedExp,
											next_block), follows);
							var restoreBreak = ctxt.putBreakLabels(this.labels,
									next_block);
							try {
								var self = this;
								...
								ctxt.contBreak.keys().forEach(function(label) {
									follows = cons(ctxt.makeGotoBlock(
													undefinedExp,
													ctxt.contBreak.get(label)),
											follows);
									follows = self.finallyBlock[Cs](follows,
											ctxt, sttop);
									contBreak.put(label, follows.car);
								});

								var contContinue = new IdentifierMap();
								ctxt.contContinue.keys().forEach(
										function(label) {
											follows = cons(
													ctxt
															.makeGotoBlock(
								...
								follows = cons(ctxt.makeGotoBlock(ctxt
														.getStackVar(sttop),
												ctxt.contReturn), follows);
								follows = this.finallyBlock[Cs](follows, ctxt,
										sttop + 1);
								follows.car
										.prependStatement(new IL.RecvStatement(ctxt
												.getStackVar(sttop)));
						...
						function make_assign(left, right) {
							return new IL.ExpStatement(new SimpleAssignExpression(
									left, right));
						}

						Expression.prototype[Cs] = function(follows, ctxt,
								sttop) {
							follows.car.prependStatement(make_assign(ctxt
											.getStackVar(sttop), this));
							return follows;
						};

						ArrayInitializer.prototype[Cs] = function(follows,
								ctxt, sttop) {
							for (var asis_from = this.elems.length - 1; asis_from >= 0; asis_from--) {
								if (this.elems[asis_from]
							...
							follows.car.prependStatement(make_assign(ctxt
											.getStackVar(sttop),
									new ArrayInitializer(elems)));
							for (var i = asis_from - 1; i >= 0; i--) {
								follows = this.elems[i][Cs](follows, ctxt,
										sttop + i);
							}
							return follows;
						};

						ObjectInitializer.prototype[Cs] = function(follows,
								ctxt, sttop) {
							for (var asis_from = this.pairs.length - 1; asis_from >= 0; asis_from--) {
								if (this.pairs[asis_from].exp
										.containsFunctionCall())
									break;
							}
							asis_from++;
							...
							follows.car.prependStatement(make_assign(ctxt
											.getStackVar(sttop),
									new ObjectInitializer(pairs)));
							for (var i = asis_from - 1; i >= 0; i--) {
								follows = this.pairs[i].exp[Cs](follows, ctxt,
										sttop + i);
							}
							return follows;
						};

						UnaryExpression.prototype[Cs] = function(follows, ctxt,
								sttop) {
							if (this.exp.containsFunctionCall()) {
								follows.car.prependStatement(make_assign(ctxt
												.getStackVar(sttop),
										new this.constructor(ctxt
												.getStackVar(sttop))));
								return this.exp[Cs](follows, ctxt, sttop);
							} else {
								return Expression.prototype[Cs].apply(this,
										arguments);
							}
						};

						BinaryExpression.prototype[Cs] = function(follows,
								ctxt, sttop) {
						...
						DotAccessor.prototype[Cs] = function(follows, ctxt,
								sttop) {
						...
						CallExpression.prototype[Cs] = function(follows, ctxt,
								sttop) {
							var self = this;
							return CsReference(this.func, ctxt, sttop,
									function(func, sttop2) {
										for (var asis_from = self.args.length
												- 1; asis_from >= 0; asis_from--) {
											if (self.args[asis_from]
													.containsFunctionCall())
												break;
										}
										asis_from++;
										var args = [];
										for (var i = 0; i < asis_from; i++) {
											args[i] = ctxt.getStackVar(sttop2
													+ i);
										}
										...
										follows = cons(
												new IL.CallBlock(
														ctxt.getScopes(),
														nil(),
														func instanceof DotAccessor
																? func.base
																: func instanceof BracketAccessor
																		? func.left
																		: new NullLiteral(),
														func, args,
														follows.car,
												...
												follows);
										for (var i = asis_from - 1; i >= 0; i--) {
											follows = self.args[i][Cs](follows,
													ctxt, sttop2 + i);
										}
										return follows;
									});
						...
						NewExpression.prototype[Cs] = function(follows, ctxt,
								sttop) {
							...
							follows.car
									.prependStatement(new IL.RecvStatement(ctxt
											.getStackVar(sttop)));
							follows = cons(new IL.NewBlock(ctxt.getScopes(),
											nil(), ctxt.getStackVar(sttop),
											args, follows.car, ctxt.contThrow),
									follows);
							for (var i = asis_from - 1; i >= 0; i--) {
								follows = this.args[i][Cs](follows, ctxt, sttop
												+ 1 + i);
							}
						...
						AssignExpression.prototype[Cs] = function(follows,
								ctxt, sttop) {
							var self = this;
							if (this.right.containsFunctionCall()) {
								return CsReference(this.left, ctxt, sttop,
										function(left, sttop2) {
											follows.car
													.prependStatement(make_assign(
															ctxt
																	.getStackVar(sttop),
						...
						AndExpression.prototype[Cs] = function(follows, ctxt,
								sttop) {
							if (this.right.containsFunctionCall()) {
								var next_block = follows.car;
								follows = cons(ctxt.makeGotoBlock(undefinedExp,
						...
						OrExpression.prototype[Cs] = function(follows, ctxt,
								sttop) {
							if (this.right.containsFunctionCall()) {
								var next_block = follows.car;
								follows = cons(ctxt.makeGotoBlock(undefinedExp,
						...
						ConditionalExpression.prototype[Cs] = function(follows,
								ctxt, sttop) {
							if (this.texp.containsFunctionCall()
									|| this.fexp.containsFunctionCall()) {
								var next_block = follows.car;
								follows = cons(ctxt.makeGotoBlock(undefinedExp,
												next_block), follows);
								...
								follows.car.prependStatement(make_assign(ctxt
												.getStackVar(sttop),
										new ConditionalExpression(ctxt
														.getStackVar(sttop),
												this.texp, this.fexp)));
								return this.cond[Cs](follows, ctxt, sttop);
							} else {
				...
				with (Concurrent.Thread.Compiler) {
					...
					return function() {
						...
						function CvConvert(func) {
							...
							return new IL.Function(func.name, func.params, vars
											.toArray(),
									concat(decls, func.body).cdr);
						}
						...
						VarStatement.prototype[Cv] = function(add_vars,
								add_decls) {
							var assigns = [];
							for (var i = 0; i < this.decls.length; i++) {
								...
								if (this.decls[i].exp) {
									assigns
											.push(new SimpleAssignExpression(
													this.decls[i].id,
													this.decls[i].exp));
								}
							}
							if (!assigns.length) {
								return new EmptyStatement([], this.lineno,
										this.source);
							} else {
								var exp = assigns[0];
								...
								return new ExpStatement([], exp, this.lineno,
										this.source);
							}
						};

						IfStatement.prototype[Cv] = function(add_vars,
								add_decls) {
							this.body = this.body[Cv](add_vars, add_decls);
							return this;
						};

						IfElseStatement.prototype[Cv] = function(add_vars,
								add_decls) {
						...
						ForVarStatement.prototype[Cv] = function(add_vars,
								add_decls) {
							var init = (new VarStatement([], this.decls))[Cv](
									add_vars, add_decls);
							...
							return new ForStatement(this.labels, init,
									this.cond, this.incr, this.body[Cv](
											add_vars, add_decls), this.lineno,
									this.source);
						};

						ForInStatement.prototype[Cv] = IfStatement.prototype[Cv];

						ForInVarStatement.prototype[Cv] = function(add_vars,
								add_decls) {
							add_vars(this.decl.id);
							var for_in = new ForInStatement(this.labels,
									this.decl.id, this.exp, this.body[Cv](
											add_vars, add_decls), this.lineno,
									this.source);
							if (this.decl.exp) {
								return new Block(
						...
						SwitchStatement.prototype[Cv] = function(add_vars,
								add_decls) {
							for (var c = this.clauses; !c.isNil(); c = c.cdr) {
								c.car = c.car[Cv](add_vars, add_decls);
							}
						...
						TryCatchStatement.prototype[Cv] = function(add_vars,
								add_decls) {
							add_vars(this.variable);
							this.tryBlock = this.tryBlock[Cv](add_vars,
									add_decls);
							this.catchBlock = this.catchBlock[Cv](add_vars,
									add_decls);
							return this;
						};

						TryFinallyStatement.prototype[Cv] = function(add_vars,
								add_decls) {
							this.tryBlock = this.tryBlock[Cv](add_vars,
									add_decls);
							this.finallyBlock = this.finallyBlock[Cv](add_vars,
									add_decls);
							return this;
						};

						TryCatchFinallyStatement.prototype[Cv] = function(
								add_vars, add_decls) {
							add_vars(this.variable);
							this.tryBlock = this.tryBlock[Cv](add_vars,
									add_decls);
						...
						FunctionDeclaration.prototype[Cv] = function(add_vars,
								add_decls) {
							add_vars(this.name);
							add_decls(new ExpStatement([],
									new SimpleAssignExpression(this.name,
			...
			with (Data.Cons) {
				with (Concurrent.Thread.Compiler) {
					...
					return function() {
						...
						var var_intermediate = new Identifier(PREFIX
								+ "intermediate");
						...
						var var_null_function = new Identifier(PREFIX
								+ "null_function");
						var null_function = new FunctionDeclaration([],
								var_null_function, [], nil());
						...
						var arguments_callee = new DotAccessor(name_arguments,
						...
						function inner_function(func) {
							...
							blocks = cons(
									var_declaration(func.vars),
									cons(
											null_function,
											cons(
													make_assign(var_args,
															name_arguments),
													cons(
															make_assign(
																	arguments_callee,
							...
							return new FunctionExpression(null, func.params,
									blocks);
						}
						...
						function make_assign(lhs, rhs) {
							return new ExpStatement([],
									new SimpleAssignExpression(lhs, rhs));
						}

						var var_cont_ex = new DotAccessor(var_cont,
								name_exception);
						...
						var assign_arguments = make_assign(name_arguments,
								var_args);

						function make_continuation(block, body) {
							body = new Block([], body);
							for (var i = block.scopes.length - 1; i >= 0; i--) {
								body = new WithStatement([], block.scopes[i],
										body);
							}
							return new VarStatement([], [{
										...
										exp : new ObjectInitializer([{
											prop : name_procedure,
											exp : new FunctionExpression(null,
													[var_intermediate], list(
															assign_arguments,
															body))
										}, {
											prop : name_this_val,
						...
						IL.CallBlock.prototype[Cz] = function() {
							...
							adder(body)(new IfElseStatement(
									...
									new AndExpression(
											this.func,
											new StrictEqualExpression(
													new TypeofExpression(new DotAccessor(
																	this.func,
																	var_compiled)),
													string_function)),
									new ReturnStatement(
											[],
											new CallExpression(
													new DotAccessor(this.func,
															var_compiled),
													[
															this.this_val,
															new ArrayInitializer(this.args),
															target_to_name(this.target)])),
									make_return(this.target,
											new CallExpression(this.func,
													this.args))));
							return make_continuation(this, body.cdr);
						};
						...
						IL.NewBlock.prototype[Cz] = function() {
							...
							body = cons(null, body);
							/*
							 * // Construct the following code-tree. if (
							 * CONSTRUCTOR && typeof
							 * CONSTRUCTOR.$Concurrent_Thread_compiled ==
							 * "function" ) {
							 * $Concurrent_Thread_null_function.prototype =
							 * CONSTRUCTOR.prototype; $Concurrent_Thread_this =
							 * new $Concurrent_Thread_null_function(); return
							 * CONSTRUCTOR.$Concurrent_Thread_compiled(
							 * $Concurrent_Thread_this, [ARG1, ARG2, ...], {
							 * procedure:
							 * function($Concurrent_Thread_intermediate){ if (
							 * !($Concurrent_Thread_intermediate && (typeof
							 * $Concurrent_Thread_intermediate === "object" ||
							 * typeof $Concurrent_Thread_intermediate ===
							 * "function") ) $Concurrent_Thread_intermediate =
							 * $Concurrent_Thread_this; $Concurrent_Thread_this =
							 * null; // encourages GC return { continuation:
							 * CONTINUATION, ret_val :
							 * $Concurrent_Thread_intermediate, timeout : void 0 }; },
							 * this_val: this, exception: EXCEPTION } ); } else {
							 * return { continuation: CONTINUATION, ret_val :
							 * new CONSTRUCTOR(ARG1, ARG2...), timeout : void 0 }; }
							 */
							adder(body)(new IfElseStatement(
									[],
									new AndExpression(
									...
									make_return(this.target, new NewExpression(
													this.func, this.args))));
							return make_continuation(this, body.cdr);
						};
						...
						IL.CondStatement.prototype[Cz] = function() {
							return new IfStatement([], this.cond,
									make_return(this.target));
						};
				...
				with (Concurrent.Thread) {
					...
					return function() {
						...
						function prepare(f) {
							...
							while (cache_history.length >= CACHE_LIMIT
									&& cache_history.length > 0) { // avoid
																	// endless
																	// loop
						...
						function prepareTree(f) {
							 ...
							 * "(function(){", " var $Concurrent_Thread_self = ",
							 * f, ";", name ? "var " + name + " = " +
							 * "$Concurrent_Thread_self;" : "", "
							 * $Concurrent_Thread_self.$Concurrent_Thread_compiled = ",
							 * func, ";", " return $Concurrent_Thread_self;",
							 * "})()"
							 */
						}
	...
	with (function() {
		with (Concurrent.Thread.Compiler) {
			...
			return function() {
				...
				WebBrowser.ScriptExecuter.register(
						"text/x-script.multithreaded-js", function(src) {
				...
				function compile(src) {
					...
					prog.vars.forEach(function(it) {
								// Incredibly, window does not have
								// hasOwnProperty method on IE!!
					...
					return [
							...
							"    $Concurrent_Thread_self.$Concurrent_Thread_compiled = ",
							prog, ";", "    return $Concurrent_Thread_self;",
							"}()"].join("");
				}
			...
			with (Concurrent) {
				with (Concurrent.Thread) {
					...
					return function() {
						 ...
						 * under the License.
						 * 
						 * The Original Code is Concurrent.Thread.Generator
						 * module.
						 * 
						 * The Initial Developer of the Original Code is Daisuke
						 * Maki. Portions created by the Initial Developer are
						...
						function Generator(f) {
							...
							this._cont_iter = eval(Thread.prepare(function() {
										f(generate);
										self._got = false;
										self._cont_iter = null; // null means
																// that the
																// iteration
																// function has
																// finished
						...
						proto.hasNext = function() {
							// This definition is called when generator is used
							// in non-converted context.
							// The implementation is quite tricky and strongly
						...
						proto.hasNext.$Concurrent_Thread_compiled = eval(Thread
								.prepare(function() {
									this._mutex.acquire();
									try {
										if (this._got)
							...
							return function() {
								...
								function bind(opts) {
									if (!(opts instanceof Object))
										throw new TypeError("argument for "
												+ NAMESPACE
												+ ".bind must be a hash.");
									...
									if (request.match(/^POST$/i)) {
										if (params.match(/^Named$/i)) {
											body = makeNamedPost(opts.url,
													opts.method);
										} else {
											body = makePositionedPost(opts.url,
													opts.method);
										}
									} else {
										if (params.match(/^Named$/i)) {
											body = makeNamedGet(opts.url,
													opts.method);
										} else {
											body = makePositionedGet(opts.url,
													opts.method);
										}
									}
									var with_pre;
								...
								var COMMON_HEADERS = ['User-Agent',
										'Concurrent.Thread.JSON.RPC', 'Accept',
										'application/json'];
											...
											.prepare(
													function( /*
														...
														var res = Thread.Http
																.get(
																		url
																				+ params2query(args2params(arguments)),
																		COMMON_HEADERS);
														res = eval("("
																+ res.responseText
																+ ")");
								...
								var JSONRPCError = Error.extend(function(
												$super, e) {
						...
						return function() {
							...
							var select = eval(Concurrent.Thread.prepare(
									function select( /* variable args */) {
										try {
											var signal = {};
											set_handlers(arrayize(arguments),
													signal);
							...
							function set_handlers(args, signal) {
								...
								var lsn_ids = args.map(function(arg) {
											function handler(e) {
												...
												// IE invalidates event
												// properties after leaving the
												// event handler.
												// So, we pass a copy of the
												// current event object (but DO
												// NOT copy its methods).
												var evt = {};
												for (var i in e) {
											...
											return attach(arg.target, arg.type,
													handler, arg.useCapture);
										});
							}
