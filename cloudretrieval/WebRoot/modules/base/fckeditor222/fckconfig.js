 ...
 * 
 * File Name: fckconfig.js Editor configuration settings. See the documentation
 * for more info.
 * 
 * File Authors: Frederico Caldeira Knabben (fredck@fckeditor.net)
 */
...
FCKConfig.ToolbarSets["hx"] = [['FontName', 'FontSize', '-', 'Bold', 'Italic',
		'Underline', '-', 'JustifyLeft', 'JustifyCenter', 'JustifyRight',
		'JustifyFull', '-', 'Cut', 'Copy', 'Paste', 'PasteText', 'PasteWord',
		'-', 'Undo', 'Redo', '-', 'OrderedList', 'UnorderedList', '-', 'Table',
...
FCKConfig.ContextMenu = ['Generic', 'Link', 'Anchor', 'Image', 'Flash',
		...
		'ImageButton', 'Button', 'BulletedList', 'NumberedList', 'TableCell',
		'Table', 'Form'];
...
FCKConfig.FontSizes = '1/1px;2/2px;3/3px;4/4px;5/5px;6/6px;7/7px;8/8px;9/9px;10/10px;11/11px;12/12px;13/13px;14/14px';
...
var _FileBrowserLanguage = 'asp'; // asp | aspx | cfm | lasso | perl | php |
									// py
...
FCKConfig.LinkUploadDeniedExtensions = ".(php|php3|php5|phtml|asp|aspx|ascx|jsp|cfm|cfc|pl|bat|exe|dll|reg|cgi)$"; // empty
																													// for
																													// no
																													// one
...
FCKConfig.ImageUploadAllowedExtensions = ".(jpg|gif|jpeg|png)$"; // empty for
																	// all
...
if (window.console)
	window.console.log('Config is loaded!'); // @Packager.Compactor.RemoveLine
