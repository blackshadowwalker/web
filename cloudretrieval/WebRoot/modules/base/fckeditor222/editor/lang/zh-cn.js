 ...
 * 
 * File Name: zh-cn.js Chinese Simplified language file.
 * 
 * File Authors: NetRube (NetRube@126.com)
 */
...
var FCKLang = {
	...
	Italic : "倾斜",
	Underline : "下划线",
	StrikeThrough : "<bean:message key="button.delete" bundle="${language}"/>线",
	Subscript : "下标",
	Superscript : "上标",
	LeftJustify : "左对齐",
	CenterJustify : "居中对齐",
	...
	NumberedList : "插入/<bean:message key="button.delete" bundle="${language}"/>编号列表",
	BulletedListLbl : "项目列表",
	BulletedList : "插入/<bean:message key="button.delete" bundle="${language}"/>项目列表",
	...
	EditLink : "编辑超链接",
	InsertRow : "插入行",
	DeleteRows : "<bean:message key="button.delete" bundle="${language}"/>行",
	InsertColumn : "插入列",
	DeleteColumns : "<bean:message key="button.delete" bundle="${language}"/>列",
	InsertCell : "插入单元格",
	DeleteCells : "<bean:message key="button.delete" bundle="${language}"/>单元格",
	MergeCells : "合并单元格",
	SplitCell : "拆分单元格",
	...
	DlgSelectOpValue : "值",
	DlgSelectBtnAdd : "新增",
	DlgSelectBtnModify : "<bean:message key="button.modify" bundle="${language}"/>",
	DlgSelectBtnUp : "上移",
	DlgSelectBtnDown : "下移",
	DlgSelectBtnSetValue : "设为初始化时选定",
	DlgSelectBtnDelete : "<bean:message key="button.delete" bundle="${language}"/>",
