function TableObject2() {
	...
	if (typeof(TableObject2._initStatus) == "undefined") {

		TableObject2.prototype.init = function(params) {

			var tmpHeight = 0;

			if (typeof params != "object") {

				alert("TableObject2.init()方法参数无效。");
			...
			if (typeof(params.tableDivId) == "string"
				...
				alert("TableObject2.init()方法中tableDivId参数必填，否则无法初始化表格。");
			...
			if (!(typeof(params.cols) == "object" && (params.cols instanceof ColsObject2))) {

				alert("TableObject2.init()方法中cols参数必填，否则无法初始化表格。");
			...
			tmpSB
					.append("<div id=\"hx_table_container2\" unselectable=\"on\" onselectstart=\"return false;\" style=\"display:none;\">");

			// 设置标题栏模块
			if (typeof(params.header) == "object"
					&& (params.header instanceof TableHeaderObject2)) {

				tmpSB.append(params.header.toHTML());

				this.header = params.header;

				// 将TableObject2对象传给TableHeaderObject对象
			...
			tmpSB.append("<div id=\"hx_table_body2\">");

			// 设置工具条模块
			if (typeof(params.toolbar) == "object"
					&& (params.toolbar instanceof ToolBarObject2)) {

				tmpSB.append(params.toolbar.toHTML());

				this.toolbar = params.toolbar;

				// 将TableObject2对象传给ToolBarObject对象
			...
			if (typeof(params.infoTip) == "object"
					&& (params.infoTip instanceof InfoTipObject2)) {

				tmpSB.append(params.infoTip.toHTML());

				this.infoTip = params.infoTip;

				// 将TableObject2对象传给InfoTipObject对象
			...
			if (typeof(params.page) == "object"
					&& (params.page instanceof PageObject2)) {

				tmpSB.append(params.cols.toHTML(params.page.perPage));

				this.page = params.page;

				// 将TableObject2对象传给PageObject对象
			...
			if (this.fadeIn == 0) {
				...
				$("#hx_table_container2").css("display", "");
			} else {

				$("#hx_table_container2").fadeIn(this.fadeIn);
			}

			var tmpHeight = this.tableHeight
					- $("#hx_table_grid_header2").height();
			...
			$("#hx_table_grid_scroll2").css("height", tmpHeight);

			$("#hx_table_container2").css("width", this.tableWidth);
			$("#hx_table_data_container2").css("width", this.tableWidth);

			if (this.tableBorderCss != "") {

				$("#hx_table_container2").css("border", this.tableBorderCss);
			}
		}

		// 取消已选行
		TableObject2.prototype.cancelSelectedRow = function(params) {
			...
			if (typeof(params) == "number" && params > 0) {
				...
				for (var i = 0; i < this.selectRowObject.length; i++) {
					...
					if (this.selectRowObject[i].line_num == row_num) {
						...
						tmpTrObj.children("#hx_custom_col2").each(
								function(num) {
				...
				for (var i = 0; i < this.selectRowObject.length; i++) {
					...
					tmpTrObj.children("#hx_custom_col2").each(function(num) {
		...
		TableObject2.prototype.setToolbarBtnDisabled = function(btnId, disabled) {
		...
		TableObject2.prototype.hiddenTipInfo = function(hidden) {

			if (typeof(hidden) == "boolean" && hidden == true) {

				$("#hx_table_infobar_div2").css("display", "none");
			} else {

				$("#hx_table_infobar_div2").css("display", "");
			}
		}

		TableObject2.prototype.hiddenToolBar = function(hidden) {

			if (typeof(hidden) == "boolean" && hidden == true) {

				$("#hx_table_toolbar2").css("display", "none");
			} else {

				$("#hx_table_toolbar2").css("display", "");
			}
		}

		TableObject2.prototype.setTipInfo = function(info) {

			if (typeof(info) == "string" && info != "") {

				$("#hx_table_infobar2").html(info);
			}
		}
		/*
		 * 更改列名
		 */
		TableObject2.prototype.modColProperty = function(params) {
			...
			if (arguments.length == 1 && typeof(params) == "object") {
				...
				if (typeof(params.col_num) == "number"
					...
					$("#hx_table_grid_header_tr2").children().each(function(i) {
						...
						if (i == params.col_num) {
							...
							if (typeof(params.col_name) == "string"
								...
								// <bean:message key="button.modify" bundle="${language}"/>列名
		 ...
		 * 设置数据
		 */
		TableObject2.prototype.setData = function(params) {
			...
			if (paramObject.length = 1 && typeof(paramObject) == "object") {
				...
				if (typeof(paramObject.data) == "object"
					...
					// 往表格中增加数据
					$("#hx_table_grid_scroll2 table tbody tr").each(
							function(i) {

								if (i + 1 > dataRowNum) {

									$(this).children("#hx_check_col2")
											.children().val("n");
								} else {
								...
								$(this).children("#hx_custom_col2").each(
										function(j) {
					...
					$("#hx_table_grid_scroll2 table tbody tr").each(
							function(i) {
								...
								$(this).children("#hx_check_col2").children()
										.val("n");
		...
		/*
		 * <bean:message key="button.delete" bundle="${language}"/>行值
		 */
		TableObject2.prototype.delRowValue = function(row_num) {
			...
			$("#hx_grid_tr_id2_" + row_num).removeClass("selected")
					.children("#hx_custom_col2").each(function(i) {

								$(this).html("&nbsp;").css("color", "#000000");

							});

			$("#hx_grid_tr_id2_" + row_num).children("#hx_check_col2")
					.children().val("d");
		 ...
		 * 设定行值
		 */
		TableObject2.prototype.setRowValue = function(params) {
			...
			if (arguments.length == 1 && typeof(params) == "object") {
				...
				// 赋值
				$("#hx_grid_tr_id2_" + params.row_num)
						.children("#hx_custom_col2").each(function(i) {
		 ...
		 * 设定列值
		 */
		TableObject2.prototype.setColValue = function(params) {
		 ...
		 * 设置行Css属性
		 */
		TableObject2.prototype.setRowCss = function(row_num, cssName) {
			...
			$("#hx_grid_tr_id2_" + row_num).addClass(cssName);
		}

		/*
		 * 获得每页显示行数
		 */
		TableObject2.prototype.getPerPage = function() {
		 ...
		 * 获得总行数
		 */
		TableObject2.prototype.getTotalRow = function() {
		 ...
		 * 获得总页数
		 */
		TableObject2.prototype.getTotalPage = function() {
		 ...
		 * 获得当前页数
		 */
		TableObject2.prototype.getCurPage = function() {
		 ...
		 */
		TableObject2.prototype.getSelectRowNum = function() {
		 ...
		 */
		TableObject2.prototype.getRowValue = function(rowNUM) {
			...
			var colO = $("#hx_grid_tr_id2_" + rowNUM + " td");
		 ...
		 */
		TableObject2.prototype.getRowColValue = function(rowNUM, colNUM) {
						...
						if ((i == 0 && tmpObject.cols.viewLineNum)
							...
							if (tmpObject.cols.viewLineNum) {
								...
								if (colNUM == i) {
									...
									value = getValue2(tmpObject, colNUM - 1,
											this);
								}
							} else {
		...
		TableObject2._initStatus = true;
	}
}

function getValue2(table_object, col, colJQueryObject) {
...
// 工具条对象
function ToolBarObject2() {
	/*
	 * { --一般按钮对象 id:'detail_id',按钮ID号 alt:'<bean:message key="button.detail" bundle="${language}"/>', title:'<bean:message key="button.detail" bundle="${language}"/>', iconCss:'detail',
	 * font_size:0, font_family:'', font_color:'', select_trigger_mode:true,
	 * handle:function(){
	 * 
	 * alert("触发<bean:message key="button.detail" bundle="${language}"/>事件"); } }, new ToolSeparatorObject(),//分割条对象 { alt:'<bean:message key="button.delete" bundle="${language}"/>',
	 ...
	 * 
	 * alert("触发<bean:message key="button.delete" bundle="${language}"/>事件"); } }, new ToolButtonBrObject()//换行对象
	 */
	...
	if (paramNum > 0) {
		...
		for (var i = 0; i < paramNum; i++) {
			...
			if ((arguments[i] instanceof ToolSeparatorObject2)
					|| (arguments[i] instanceof ToolButtonBrObject2)
					|| (arguments[i] instanceof DefaultDataToXlsBtnObject2)) {// 工具分隔符、回车符以及导出Excel按钮
		...
		obj.toHTML = function() {
			...
			if (paramArrs.length == 0) {
				...
				return "<div id=\"hx_table_toolbar2\" title=\"工具条\"></div>";
			}

			var tmpSB = new StringBuffer();

			tmpSB
					.append("<div id=\"hx_table_toolbar2\" title=\"工具条\"><table cellpadding=\"0\" cellspacing=\"0\" style=\"width:auto;height:100%;\"><tr>");

			for (var i = 0; i < paramArrs.length; i++) {

				if (paramArrs[i] instanceof ToolSeparatorObject2) {// 分隔符

					tmpSB.append("<td>").append(paramArrs[i].toHTML())
							.append("</td>");
				} else if (paramArrs[i] instanceof ToolButtonBrObject2) {// 换行

					tmpSB.append("</tr><tr>");
				} else if (paramArrs[i] instanceof DefaultDataToXlsBtnObject2) {// 导出Excel按钮
					...
					if (typeof(paramArrs[i].id) == "string"
						...
						paramArrs[i].id = "hx_toolbar_event2_" + i;

						tmpSB.append("hx_toolbar_event2_").append(i);
					}
					...
					if (paramArrs[i].iconCss != "") {
						...
						if (typeof(paramArrs[i].title) == "string"
							...
							tmpSB.append("hx_table_toolbar_btn2 ");
						} else {

							tmpSB.append("hx_table_toolbar_btn2_3 ");
						}
						...
						tmpSB.append("hx_table_toolbar_btn2_2\" title=\"");
					}
		...
		obj.addEvent = function() {
			...
			if (paramArrs.length == 0) {
				...
				for (var i = 0; i < paramArrs.length; i++) {
					...
					if (!(paramArrs[i] instanceof ToolSeparatorObject2)
							&& !(paramArrs[i] instanceof ToolButtonBrObject2)) {
...
function TableHeaderObject2() {
	...
	obj.toHTML = function() {
		...
		tmpSB
				.append("<div id=\"hx_table_header2\"><span id=\"hx_table_header_text\">");
...
function PageObject2() {
	...
	if (arguments.length > 0 && typeof(arguments[0]) == "object") {
		...
		if (typeof(tmp.sep) == "object"
				&& (tmp.sep instanceof PageSeparatorObject2)) {
	...
	obj.toHTML = function() {
		...
		tmpSB.append("<div id=\"hx_table_page2\">");
		tmpSB.append("<table cellpadding=\"0\" cellspacing=\"0\">");
		tmpSB.append("<tbody>");
		tmpSB.append("<tr>");
		tmpSB
				.append("<td><button type=\"button\" id=\"hx_table_firstpage_btn2\" disabled class=\"hx_table_page_tn2 disabled_first_btn2\" title=\"第一页\"></button></td>");
		...
		tmpSB
				.append("<td><button type=\"button\" id=\"hx_table_privpage_btn2\" disabled class=\"hx_table_page_tn2 disabled_priv_btn2\" title=\"上一页\"></button></td>");
		...
		tmpSB
				.append("<td><button type=\"button\" id=\"hx_table_nextpage_btn2\" disabled class=\"hx_table_page_tn2 disabled_next_btn2\" title=\"下一页\"></button></td>");
		...
		tmpSB
				.append("<td><button type=\"button\" id=\"hx_table_lastpage_btn2\" disabled class=\"hx_table_page_tn2 disabled_last_btn2\" title=\"最后页\"></button></td>");
		...
		if (obj.viewJumpWidget) {
			...
			tmpSB
					.append("<td><span class=\"jumpPage2\">&nbsp;&nbsp;转到第<input type=\"text\" id=\"hx_table_page_text2\" disabled/>页</span></td>");
		}

		if (obj.viewPageInfoWidget) {

			tmpSB
					.append("<td width=\"100%\" align=\"right\"><span id=\"hx_table_page_info2\">共")
	...
	obj.reloadPage = function() {
		...
		if (obj.curPage <= 1) {
			...
			// 禁用'首页'按钮
			$("#hx_table_firstpage_btn2").removeClass("first_btn2")
					.addClass("disabled_first_btn2").get(0).disabled = true;
			// 禁用'上一页'按钮
			$("#hx_table_privpage_btn2").removeClass("priv_btn2")
					.addClass("disabled_priv_btn2").get(0).disabled = true;
		} else if (obj.curPage == obj.totalPage) {

			// 启用'首页'按钮
			$("#hx_table_firstpage_btn2").removeClass("disabled_first_btn2")
					.addClass("first_btn2").get(0).disabled = false;
			// 启用'上一页'按钮
			$("#hx_table_privpage_btn2").removeClass("disabled_priv_btn2")
					.addClass("priv_btn2").get(0).disabled = false;
			/*
			 * //禁用'下一页'按钮
		...
		if (obj.totalPage <= 1 || obj.totalPage == obj.curPage) {
			...
			// 禁用'下一页'按钮
			$("#hx_table_nextpage_btn2").removeClass("next_btn2")
					.addClass("disabled_next_btn2").get(0).disabled = true;
			// 禁用'最后页'按钮
			$("#hx_table_lastpage_btn2").removeClass("last_btn2")
					.addClass("disabled_last_btn2").get(0).disabled = true;
		} else {

			// 启用'下一页'按钮
			$("#hx_table_nextpage_btn2").removeClass("disabled_next_btn2")
					.addClass("next_btn2").get(0).disabled = false;
			// 启用'最后页'按钮
			$("#hx_table_lastpage_btn2").removeClass("disabled_last_btn2")
					.addClass("last_btn2").get(0).disabled = false;
		}

		if (obj.totalPage > 1 && obj.viewJumpWidget) {

			// 启用'跳转'文本框
			$("#hx_table_page_text2").get(0).disabled = false;
		} else if (obj.totalPage <= 1 && obj.viewJumpWidget) {

			// 禁用'跳转'文本框
			$("#hx_table_page_text2").get(0).disabled = true;
		}

		if (obj.viewPageInfoWidget) {

			$("#hx_table_page_info2").text("共" + obj.totalRow + "条记录，当前第"
		...
		if (typeof(obj.handle) == "function" && isFirst == true) {
			...
			// '首页'按钮事件
			$("#hx_table_firstpage_btn2").click(function() {
			...
			// '上一页'按钮事件
			$("#hx_table_privpage_btn2").click(function() {
			...
			// '下一页'按钮事件
			$("#hx_table_nextpage_btn2").click(function() {
			...
			// '最后页'按钮事件
			$("#hx_table_lastpage_btn2").click(function() {
			...
			if (obj.viewJumpWidget) {
				...
				// 跳转文本框'回车'事件
				$("#hx_table_page_text2").keydown(function() {
...
function ColsObject2() {
	...
	if (arguments.length > 0 && typeof(arguments[0]) == "object") {
		...
		if (typeof(tmpColArr) != "object" && !(tmpColArr instanceof Array)) {
			...
			alert("ColsObject2对象参数格式不对，无法初始化。");
		...
		for (var i = 0; i < tmpColArr.length; i++) {
			...
			if (typeof(tmpColArr[i].alias) != "string"
				...
				alert("ColsObject2对象参数中alias没有定义或不合法。");
		...
		obj.toHTML = function(viewRowNum) {// 显示总行数
			...
			tmpSB.append("<div id=\"hx_table_data_container2\">");
			tmpSB.append("<div id=\"hx_table_grid_header2\">");
			tmpSB
					.append("<table cellpadding=\"0\" cellspacing=\"0\" style=\"width:")
					.append(obj.gridWidth).append("px;height:100%;\">");
			tmpSB.append("<tr id=\"hx_table_grid_header_tr2\">");

			if (obj.viewLineNum) {

				tmpSB.append("<td id=\"header_line_num2\">&nbsp;</td>");
			}
			...
			tmpSB
					.append("<div id=\"hx_table_grid_scroll2\"><div id=\"hx_scroll_div2\" style=\"margin-bottom:0px;\">");
			tmpSB
					.append("<table cellpadding=\"0\" cellspacing=\"0\" style=\"width:")
			...
			for (var i = 1; i <= viewRowNum; i++) {
				...
				tmpSB.append("<tr id=\"hx_grid_tr_id2_").append(i)
						.append("\" line_num=\"" + i + "\">");

				// 是否显示行号
				if (obj.viewLineNum) {

					tmpSB.append("<td id=\"hx_grid_num2\">").append(i)
							.append("</td>");
				}
				...
				for (var ii = 0; ii < obj.cols.length; ii++) {
					...
					if (obj.cols[ii].hide) {// 列隐藏
						...
						tmpSB
								.append("<td id=\"hx_custom_col2\" width=\"")
								.append(obj.cols[ii].width)
								.append("\" style=\"display:none\">&nbsp;</td>");
					} else {

						tmpSB.append("<td id=\"hx_custom_col2\" width=\"")
								.append(obj.cols[ii].width)
								.append("\">&nbsp;</td>");
					}
				}
				...
				// 增加隐藏列，用于判断是否数据行
				tmpSB
						.append("<td  id=\"hx_check_col2\" style=\"display:none\"><input type=\"hidden\" value=\"n\"/></td>");
			...
			tmpSB
					.append("</tbody></table><form id=\"hx_t_form2\" method=\"POST\" target=\"_hx_iframe2\"></form>");
			tmpSB
					.append("<iframe id=\"_hx_iframe2\" name=\"_hx_iframe2\" style=\"display:none;\"></iframe></div></div></div>");
		...
		obj.reloadGridClickHandle = function() {
			...
			$("#hx_table_grid_scroll2 table tbody tr").hover(
			...
			function() {
				 ...
				 * tmpTrObj.removeClass("selected"); }
				 * 
				 * //<bean:message key="button.delete" bundle="${language}"/>用户所有已选行信息
				 ...
				 */if (event.ctrlKey == false && event.shiftKey == false) {// 左键单选处理
					...
					if (trObj.children("#hx_check_col2").children().val() == "d") {
					...
					if (trObj.children("#hx_check_col2").children().val() == "y") {
					...
					trObj.children("#hx_custom_col2").each(function(i) {
					...
					if (isSelected == true) {// 此行之前已被选，反选处理
						...
						for (var i = 0; i < obj.tObject.selectRowObject.length; i++) {
							...
							if (line_num == obj.tObject.selectRowObject[i].line_num) {
								...
								// <bean:message key="button.delete" bundle="${language}"/>已保存行信息
...
// 工具条中按钮分割条对象
function ToolSeparatorObject2() {

	this.sepLabelContent = "|";

	this.sepLabelCss = "toolbar-sep2";
	...
	if (typeof ToolSeparatorObject2._initStatus == "undefined") {

		ToolSeparatorObject2.prototype.toHTML = function() {
		...
		ToolSeparatorObject2._initStatus = true;
	}
}

// 分页中按钮分割条对象
function PageSeparatorObject2() {

	this.sepLabelContent = "|";

	this.sepLabelCss = "page-sep2";
	...
	if (typeof PageSeparatorObject2._initStatus == "undefined") {

		PageSeparatorObject2.prototype.toHTML = function() {
		...
		PageSeparatorObject2._initStatus = true;
	}
}

function InfoTipObject2(params) {
	...
	if (arguments.length == 1 && typeof(params) == "object") {
		...
		if (typeof(params.label) == "string" && params.label != "") {
			...
			InfoTipObject2.prototype.toHTML = function() {

				return "<div id=\"hx_table_infobar_div2\" title=\"信息提示栏\">&nbsp;&nbsp;"
						+ this.label
						+ "&nbsp;<span id=\"hx_table_infobar2\"></span></div>";
			}
		} else {

			InfoTipObject2.prototype.toHTML = function() {

				return "<div id=\"hx_table_infobar_div2\" title=\"信息提示栏\"><span id=\"hx_table_infobar2\"></span></div>";
			}
		}
	} else {
...
function DefaultDataToXlsBtnObject2(params) {
	...
	obj.handle = function(toolbarObject) {
		...
		var formObj = $("#hx_t_form2");

		formObj
				.attr("action", obj.url)
				.append($("<input id=\"xls_data_input2\" type=\"hidden\" name=\"xls_datas\"/>"));
		...
		if (gridTotalRow > 0) {
			...
			for (var i = 1; i <= gridTotalRow; i++) {
				...
				var tmpTrObj = $("#hx_grid_tr_id2_" + i);

				if (tmpTrObj.children("#hx_check_col2").children().val() == "y") {// 是数据行
					...
					// 获得此行没列数据
					tmpTrObj.children("#hx_custom_col2").each(function(i) {
			...
			formObj.children("#xls_data_input2").val(dataSB.toString());
...
function DefaultDataToDocBtnObject2(params) {
	...
	obj.handle = function(toolbarObject) {
		...
		formObj
				.attr("action", obj.url)
				.append($("<input id=\"doc_data_input2\" type=\"hidden\" name=\"doc_datas\"/>"));
		...
		if (gridTotalRow > 0) {
			...
			formObj.children("#doc_data_input2").val(dataSB.toString());
