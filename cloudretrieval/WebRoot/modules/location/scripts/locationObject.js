	...
	tObject.init({
				...
				cols : new ColsObject({
							...
							cols : [{
										...
										name : '<bean:message key="location.columns.code" bundle="${language}"/>',//地域编号',
										alias : 'locationId',
										width : 170
									},{
										name : '<bean:message key="location.columns.name" bundle="${language}"/>',//地域名称',
										alias : 'locationName',
										width : 170
									}, {
										name : '<bean:message key="location.columns.longitude" bundle="${language}"/>',//地域经度',
										alias : 'longitude',
										width : 120
									}, {
										name : '<bean:message key="location.columns.latitude" bundle="${language}"/>',//地域纬度',
										alias : 'latiTude',
										width : 100
									}, {
										name : '<bean:message key="location.columns.mapScaling" bundle="${language}"/>',//地图缩放比例',
										alias : 'mapScaling',
										width : 100
									}]
						}),
