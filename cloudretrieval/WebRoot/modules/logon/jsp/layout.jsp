...
#loginpannel{
	...
	background: url(modules/logon/image/dj.png) no-repeat;
	position:absolute;
	left: 30%;
	top: 25%;
	z-index:100;
...
<div id=loginpannel align=center style="border:0px #0f0 solid; width:550px; height:350px;">
		...
		<div style="position: relative; left:30px; top:20px;float:left;" width=70 height=75>
			<img src="modules/logon/image/jc.png"  width=70 height=70/>
		</div>
