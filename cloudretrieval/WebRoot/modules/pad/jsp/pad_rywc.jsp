...
<br>
<br>
 <div align="center"><font color="#0000FF" size="5"><strong>任务情况统计</strong></font></div>
<hr>
<table width="100%"  border="1" bordercolor="#000000" align="center" cellpadding="0" cellspacing="0" >
  <tr bgcolor="#EEF5F2"> 
    ...
    <td > <div align="center"><font color="#0000FF"><strong>发布任务数</strong></font></div></td>
    <td > <div align="center"><font color="#0000FF"><strong>当日任务总数</strong></font></div></td>
    <td > <div align="center"><font color="#0000FF"><strong>需完成任务数</strong></font></div></td>
    <td > <div align="center"><font color="#0000FF"><strong>已完成任务数</strong></font></div></td>
    <td > <div align="center"><font color="#0000FF"><strong>上日未完成任务数</strong></font></div></td>
