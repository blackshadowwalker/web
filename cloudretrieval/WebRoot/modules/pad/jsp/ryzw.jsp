...
<table width="100%"  border="1" bordercolor="#000000" align="center" cellpadding="0" cellspacing="0" >
  <tr bgcolor="#EEF5F2"> 
    ...
    <td > <div align="center"><font color="#0000FF"><strong>姓名</strong></font></div></td>
 ...
 dwr.engine.setAsync(false);
  padBean.getrylb(rowID.split("</C>")[0],rowID.split("</C>")[1],{
 ...
 function ckry(id)
 {
	var srcFile = "<%=thisPath%>/modules/jcxx/person/jsp/personDetail.jsp";
