...
<style type="text/css">
<!--
.myLink01:link{	color:Green;	text-decoration:none;}
.myLink01:visited{color:Green;	text-decoration:none;}
.myLink01:hover{color:Green;	text-decoration:underline;}
/*样式2(myLink02)*/
.myLink02:link{	color:red;	text-decoration:none;}
.myLink02:visited{color:red;	text-decoration:none;}
.myLink02:hover{color:red;	text-decoration:none;}
--></style>
...
<div align="center">
<font color='#0000FF' size=2>指定月份<bean:message key="button.query" bundle="${language}"/>
...
dyxx +="<font color='#0000FF' size=5>"+my.getFullYear() + "年" + (my.getMonth()+1)+"月</font><br><font color='#0000FF' size=2>(注：蓝字表示计划休假，红字表示休假状态,<img src='<%=thisPath%>/modules/pad/image/ball5.gif' width='10' height='10'>表示领导警员，<img src='<%=thisPath%>/modules/pad/image/ball4.gif' width='10' height='10'>表示非领导警员)</font>";
dyxx +="<table border='1'bordercolor='#000000'  width='100%' height='95%'>";
