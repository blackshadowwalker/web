...
<script>
    ...
    deptBean.detailTSDept(rowID,
    {
        callback:function(data)
        {
            ...
            document.write("<tr><td class=tablebodyhead width=150px><bean:message key="dept.columns.deptCode" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[0]+"</td></tr>");
            document.write("<tr><td class=tablebodyhead><bean:message key="dept.columns.deptName" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[1]+"</td></tr>");
            
              document.write("<tr><td class=tablebodyhead><bean:message key="dept.columns.deptManager" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[2]+"</td></tr>");
            
            document.write("<tr><td class=tablebodyhead><bean:message key="dept.columns.deptLeader" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[3]+"</td></tr>");
            
            document.write("<tr><td class=tablebodyhead><bean:message key="dept.columns.status" bundle="${language}"/></td>");
