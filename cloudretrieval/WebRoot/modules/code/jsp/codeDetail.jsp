...
<script>
    ...
    codeBean.detailTSCode(rowID,
    {
        callback:function(data)
        {
            ...
            document.write("<tr><td class=tablebodyhead width=150px><bean:message key="basedata.label.codetype" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[1]+"</td></tr>");
            document.write("<tr><td class=tablebodyhead><bean:message key="basedata.label.codevalue" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[2]+"</td></tr>");
            document.write("<tr><td class=tablebodyhead><bean:message key="basedata.label.codetext" bundle="${language}"/></td>");
            document.write("<td class=tablebody>"+colElements[3]+"</td></tr>");
            document.write("<tr><td class=tablebodyhead><bean:message key="basedata.label.comment" bundle="${language}"/></td>");
