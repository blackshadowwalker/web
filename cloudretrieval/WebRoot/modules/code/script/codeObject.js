	...
	tObject.init({
				...
				cols : new ColsObject({
							...
							cols : [{
										...
										name : '<bean:message key="basedata.label.codetype" bundle="${language}"/>',
										alias : 'type',
										width : 150
									}, {
										name : '<bean:message key="basedata.label.codevalue" bundle="${language}"/>',
										alias : 'code',
										width : 100
									}, {
										name : '<bean:message key="basedata.label.codetext" bundle="${language}"/>',
										alias : 'value',
										width : 150
									}]
						}),
