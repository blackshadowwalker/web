...
.full dl.error dt img{padding-top:13px; width:200px; height:45px;  background:url(error/images/logo_186_x_45.png) -20px 0px no-repeat;}
...
<BODY>
		<DIV>
			...
			<DIV class="full">
				<DL class="error">
					<DT>
						<IMG title="404 提示页面" alt="404 提示页面" src="error/images/pic_dot.gif">
					</DT>
					<DD class=error404 >
						<IMG   title="404 提示页面" alt="404 提示页面" src="error/images/pic_dot.gif">
					</DD>
					...
					<DD>
						<SPAN class="btn_back"> <A href="<%=basePath %>" target="_self"><IMG title="返回" alt="返回" src="error/images/pic_dot.gif"> </A> </SPAN>
					</DD>
				</DL>
			</DIV>
			<DIV
				...
				<div id="pub_footerall" class="pub_footerall">
					<dl>
						...
						<dd>
							...
							<a
								href="http://qyxy.baic.gov.cn/kscx/kscxAction!view.dhtml?kscxModel.reg_bus_ent_id=a1a1a1a02f47f8c3012f484723e77b1f&flag_cer=0"
								target="_blank"> <img
